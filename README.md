...
`更新时间：2021-05-02 05:10:01 +0800`

## 今日热门仓库

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,783** &nbsp;&nbsp; folks: **414**  &nbsp;&nbsp; `504 stars today`

1. [Kotlin / kmm-production-sample](https://github.com/Kotlin/kmm-production-sample)
    - 无
    - language: **Kotlin** &nbsp;&nbsp; stars: **403** &nbsp;&nbsp; folks: **14**  &nbsp;&nbsp; `135 stars today`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an open source driver assistance system. openpilot performs the functions of Automated Lane Centering and Adaptive Cruise Control for over 100 supported car makes and models.
    - language: **C++** &nbsp;&nbsp; stars: **23,825** &nbsp;&nbsp; folks: **4,945**  &nbsp;&nbsp; `265 stars today`
...
1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    ...
    - language: **无** &nbsp;&nbsp; stars: **23,120** &nbsp;&nbsp; folks: **3,175**  &nbsp;&nbsp; `246 stars today`

1. [androidmalware / android_hid](https://github.com/androidmalware/android_hid)
    - Use Android as Rubber Ducky against another Android device
    - language: **Shell** &nbsp;&nbsp; stars: **815** &nbsp;&nbsp; folks: **134**  &nbsp;&nbsp; `45 stars today`
...
1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,861** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `18 stars today`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,657** &nbsp;&nbsp; folks: **201**  &nbsp;&nbsp; `241 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,886** &nbsp;&nbsp; folks: **17,496**  &nbsp;&nbsp; `336 stars today`
...
1. [nextapps-de / winbox](https://github.com/nextapps-de/winbox)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,261** &nbsp;&nbsp; folks: **35**  &nbsp;&nbsp; `494 stars today`
...
1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **40,708** &nbsp;&nbsp; folks: **6,062**  &nbsp;&nbsp; `104 stars today`

1. [PaddlePaddle / PaddleDetection](https://github.com/PaddlePaddle/PaddleDetection)
    - Object detection and instance segmentation toolkit based on PaddlePaddle.
    - language: **Python** &nbsp;&nbsp; stars: **2,990** &nbsp;&nbsp; folks: **799**  &nbsp;&nbsp; `138 stars today`
...
1. [terraform-providers / terraform-provider-azurerm](https://github.com/terraform-providers/terraform-provider-azurerm)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,512** &nbsp;&nbsp; folks: **2,406**  &nbsp;&nbsp; `22 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,886** &nbsp;&nbsp; folks: **17,496**  &nbsp;&nbsp; `2,109 stars this week`
...
1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,657** &nbsp;&nbsp; folks: **201**  &nbsp;&nbsp; `1,560 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,790** &nbsp;&nbsp; folks: **8,068**  &nbsp;&nbsp; `3,836 stars this month`
