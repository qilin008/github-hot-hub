...
1. [rbignon / doctoshotgun](https://github.com/rbignon/doctoshotgun)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **213** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `81 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,342** &nbsp;&nbsp; folks: **7,510**  &nbsp;&nbsp; `94 stars today`

1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,622** &nbsp;&nbsp; folks: **1,951**  &nbsp;&nbsp; `108 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,449** &nbsp;&nbsp; folks: **371**  &nbsp;&nbsp; `98 stars today`

1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,314** &nbsp;&nbsp; folks: **3,247**  &nbsp;&nbsp; `136 stars today`

1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,434** &nbsp;&nbsp; folks: **1,708**  &nbsp;&nbsp; `192 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,141** &nbsp;&nbsp; folks: **1,679**  &nbsp;&nbsp; `108 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,522** &nbsp;&nbsp; folks: **1,841**  &nbsp;&nbsp; `331 stars today`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,932** &nbsp;&nbsp; folks: **1,485**  &nbsp;&nbsp; `140 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,085** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `669 stars today`

1. [google / iosched](https://github.com/google/iosched)
    - The Google I/O Android App
    - language: **Kotlin** &nbsp;&nbsp; stars: **20,435** &nbsp;&nbsp; folks: **6,118**  &nbsp;&nbsp; `51 stars today`
...
1. [microsoft / TypeScript](https://github.com/microsoft/TypeScript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,157** &nbsp;&nbsp; folks: **9,350**  &nbsp;&nbsp; `149 stars today`

1. [facebookresearch / pytorchvideo](https://github.com/facebookresearch/pytorchvideo)
    - A deep learning library for video understanding research.
    - language: **Python** &nbsp;&nbsp; stars: **1,084** &nbsp;&nbsp; folks: **56**  &nbsp;&nbsp; `140 stars today`

1. [apache / spark](https://github.com/apache/spark)
    - Apache Spark - A unified analytics engine for large-scale data processing
    - language: **Scala** &nbsp;&nbsp; stars: **29,840** &nbsp;&nbsp; folks: **23,881**  &nbsp;&nbsp; `58 stars today`

1. [parcel-bundler / parcel](https://github.com/parcel-bundler/parcel)
    - 📦🚀 Blazing fast, zero configuration web application bundler
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,312** &nbsp;&nbsp; folks: **1,933**  &nbsp;&nbsp; `139 stars today`
...
1. [tuteng / Best-websites-a-programmer-should-visit-zh](https://github.com/tuteng/Best-websites-a-programmer-should-visit-zh)
    - 程序员应该访问的最佳网站中文版
    - language: **无** &nbsp;&nbsp; stars: **5,357** &nbsp;&nbsp; folks: **812**  &nbsp;&nbsp; `241 stars today`

1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **66,938** &nbsp;&nbsp; folks: **21,042**  &nbsp;&nbsp; `142 stars today`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **9,809** &nbsp;&nbsp; folks: **2,266**  &nbsp;&nbsp; `133 stars today`

1. [Kong / kong](https://github.com/Kong/kong)
    - 🦍 The Cloud-Native API Gateway
    - language: **Lua** &nbsp;&nbsp; stars: **29,148** &nbsp;&nbsp; folks: **3,817**  &nbsp;&nbsp; `105 stars today`

1. [yichahucha / surge](https://github.com/yichahucha/surge)
    - Some useful scripts.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,614** &nbsp;&nbsp; folks: **458**  &nbsp;&nbsp; `42 stars today`

1. [frappe / erpnext](https://github.com/frappe/erpnext)
    - World's best free and open source ERP.
    - language: **Python** &nbsp;&nbsp; stars: **8,531** &nbsp;&nbsp; folks: **3,574**  &nbsp;&nbsp; `132 stars today`
...
1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,434** &nbsp;&nbsp; folks: **1,708**  &nbsp;&nbsp; `1,646 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,599** &nbsp;&nbsp; folks: **966**  &nbsp;&nbsp; `3,758 stars this month`

1. [DIGITALCRIMINAL / OnlyFans](https://github.com/DIGITALCRIMINAL/OnlyFans)
    - Scrape all the media from an OnlyFans account - Updated regularly
    - language: **Python** &nbsp;&nbsp; stars: **1,660** &nbsp;&nbsp; folks: **245**  &nbsp;&nbsp; `869 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **9,809** &nbsp;&nbsp; folks: **2,266**  &nbsp;&nbsp; `3,701 stars this month`

1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    - An operating system, but it only plays Tetris.
    - language: **C** &nbsp;&nbsp; stars: **3,163** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `2,328 stars this month`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **107,926** &nbsp;&nbsp; folks: **29,923**  &nbsp;&nbsp; `5,810 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,198** &nbsp;&nbsp; folks: **8,251**  &nbsp;&nbsp; `4,413 stars this month`
...
1. [zellij-org / zellij](https://github.com/zellij-org/zellij)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **2,890** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `1,941 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,792** &nbsp;&nbsp; folks: **533**  &nbsp;&nbsp; `3,763 stars this month`
