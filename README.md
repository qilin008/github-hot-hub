...
`更新时间：2021-04-30 12:14:15 +0800`

## 今日热门仓库

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,103** &nbsp;&nbsp; folks: **29,491**  &nbsp;&nbsp; `468 stars today`

1. [scala-open-letter / scala-open-letter.github.io](https://github.com/scala-open-letter/scala-open-letter.github.io)
    - 无
    - language: **Ruby** &nbsp;&nbsp; stars: **64** &nbsp;&nbsp; folks: **275**  &nbsp;&nbsp; `35 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,459** &nbsp;&nbsp; folks: **17,455**  &nbsp;&nbsp; `398 stars today`

1. [openssl / openssl](https://github.com/openssl/openssl)
    - TLS/SSL and crypto library
    - language: **C** &nbsp;&nbsp; stars: **15,506** &nbsp;&nbsp; folks: **6,837**  &nbsp;&nbsp; `128 stars today`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **3,343** &nbsp;&nbsp; folks: **842**  &nbsp;&nbsp; `307 stars today`

1. [Developer-Y / cs-video-courses](https://github.com/Developer-Y/cs-video-courses)
    - List of Computer Science courses with video lectures.
    - language: **无** &nbsp;&nbsp; stars: **22,811** &nbsp;&nbsp; folks: **3,159**  &nbsp;&nbsp; `211 stars today`
...
1. [nextapps-de / winbox](https://github.com/nextapps-de/winbox)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,702** &nbsp;&nbsp; folks: **28**  &nbsp;&nbsp; `678 stars today`
...
1. [nekohasekai / SagerNet](https://github.com/nekohasekai/SagerNet)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **880** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `147 stars today`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,400** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `212 stars today`
...
1. [tuvtran / project-based-learning](https://github.com/tuvtran/project-based-learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **48,404** &nbsp;&nbsp; folks: **7,635**  &nbsp;&nbsp; `192 stars today`
...
1. [airbus-seclab / qemu_blog](https://github.com/airbus-seclab/qemu_blog)
    ...
    - language: **无** &nbsp;&nbsp; stars: **516** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `124 stars today`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,825** &nbsp;&nbsp; folks: **114**  &nbsp;&nbsp; `1,449 stars this week`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,400** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `1,207 stars this week`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,148** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `997 stars this week`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **4,920** &nbsp;&nbsp; folks: **712**  &nbsp;&nbsp; `1,327 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **5,124** &nbsp;&nbsp; folks: **564**  &nbsp;&nbsp; `962 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,103** &nbsp;&nbsp; folks: **29,491**  &nbsp;&nbsp; `2,661 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,709** &nbsp;&nbsp; folks: **8,056**  &nbsp;&nbsp; `1,289 stars this week`

1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **102,797** &nbsp;&nbsp; folks: **41,029**  &nbsp;&nbsp; `985 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **185,946** &nbsp;&nbsp; folks: **41,878**  &nbsp;&nbsp; `2,682 stars this week`
...
1. [ericaltendorf / plotman](https://github.com/ericaltendorf/plotman)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **269** &nbsp;&nbsp; folks: **82**  &nbsp;&nbsp; `110 stars this week`
