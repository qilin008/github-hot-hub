...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **704** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `219 stars today`
...
1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,329** &nbsp;&nbsp; folks: **2,876**  &nbsp;&nbsp; `294 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **1,152** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `253 stars today`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,613** &nbsp;&nbsp; folks: **250**  &nbsp;&nbsp; `190 stars today`

1. [symfony / symfony](https://github.com/symfony/symfony)
    - The Symfony PHP framework
    - language: **PHP** &nbsp;&nbsp; stars: **24,879** &nbsp;&nbsp; folks: **8,053**  &nbsp;&nbsp; `10 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,903** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `175 stars today`
...
1. [mytechnotalent / Reverse-Engineering](https://github.com/mytechnotalent/Reverse-Engineering)
    ...
    - language: **C** &nbsp;&nbsp; stars: **3,505** &nbsp;&nbsp; folks: **298**  &nbsp;&nbsp; `99 stars today`

1. [mrdoob / three.js](https://github.com/mrdoob/three.js)
    - JavaScript 3D library.
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,146** &nbsp;&nbsp; folks: **27,155**  &nbsp;&nbsp; `282 stars today`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **62,459** &nbsp;&nbsp; folks: **6,112**  &nbsp;&nbsp; `111 stars today`

1. [ansible / ansible](https://github.com/ansible/ansible)
    - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
    - language: **Python** &nbsp;&nbsp; stars: **47,450** &nbsp;&nbsp; folks: **20,441**  &nbsp;&nbsp; `14 stars today`

1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **47,097** &nbsp;&nbsp; folks: **12,580**  &nbsp;&nbsp; `75 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,220** &nbsp;&nbsp; folks: **16,891**  &nbsp;&nbsp; `2,629 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,039** &nbsp;&nbsp; folks: **794**  &nbsp;&nbsp; `1,075 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,613** &nbsp;&nbsp; folks: **250**  &nbsp;&nbsp; `636 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,173** &nbsp;&nbsp; folks: **7,777**  &nbsp;&nbsp; `420 stars this week`
...
1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    - The Intuitive Vue Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,329** &nbsp;&nbsp; folks: **2,876**  &nbsp;&nbsp; `806 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,794** &nbsp;&nbsp; folks: **1,106**  &nbsp;&nbsp; `5,494 stars this month`

1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    - Run Mac in a Docker! Run near native OSX-KVM in Docker! X11 Forwarding! CI/CD for OS X!
    - language: **Shell** &nbsp;&nbsp; stars: **13,197** &nbsp;&nbsp; folks: **578**  &nbsp;&nbsp; `4,580 stars this month`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **7,039** &nbsp;&nbsp; folks: **794**  &nbsp;&nbsp; `3,863 stars this month`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,446** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `3,834 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **117,228** &nbsp;&nbsp; folks: **16,760**  &nbsp;&nbsp; `3,688 stars this month`

1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,054** &nbsp;&nbsp; folks: **9,846**  &nbsp;&nbsp; `1,564 stars this month`
...
1. [openjdk / jdk](https://github.com/openjdk/jdk)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,756** &nbsp;&nbsp; folks: **2,096**  &nbsp;&nbsp; `874 stars this month`
...
1. [facebook / react](https://github.com/facebook/react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **166,272** &nbsp;&nbsp; folks: **33,381**  &nbsp;&nbsp; `2,167 stars this month`
...
1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **124,971** &nbsp;&nbsp; folks: **40,535**  &nbsp;&nbsp; `3,187 stars this month`
