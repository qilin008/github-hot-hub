...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,711** &nbsp;&nbsp; folks: **1,453**  &nbsp;&nbsp; `86 stars today`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,819** &nbsp;&nbsp; folks: **4,794**  &nbsp;&nbsp; `350 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,391** &nbsp;&nbsp; folks: **7,939**  &nbsp;&nbsp; `477 stars today`

1. [vitling / acid-banger](https://github.com/vitling/acid-banger)
    - The Endless Acid Banger
    - language: **TypeScript** &nbsp;&nbsp; stars: **652** &nbsp;&nbsp; folks: **26**  &nbsp;&nbsp; `97 stars today`
...
1. [CyberPunkMetalHead / Binance-News-Sentiment-Bot](https://github.com/CyberPunkMetalHead/Binance-News-Sentiment-Bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **807** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `193 stars today`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,865** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `240 stars today`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,598** &nbsp;&nbsp; folks: **523**  &nbsp;&nbsp; `505 stars today`
...
1. [zellij-org / zellij](https://github.com/zellij-org/zellij)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,338** &nbsp;&nbsp; folks: **37**  &nbsp;&nbsp; `146 stars today`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,612** &nbsp;&nbsp; folks: **882**  &nbsp;&nbsp; `181 stars today`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,274** &nbsp;&nbsp; folks: **1,539**  &nbsp;&nbsp; `90 stars today`
...
1. [CleverProgrammers / cp-disney-plus-clone](https://github.com/CleverProgrammers/cp-disney-plus-clone)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **83** &nbsp;&nbsp; folks: **43**  &nbsp;&nbsp; `24 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,054** &nbsp;&nbsp; folks: **360**  &nbsp;&nbsp; `157 stars today`
...
1. [NeuromatchAcademy / course-content-dl](https://github.com/NeuromatchAcademy/course-content-dl)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **81** &nbsp;&nbsp; folks: **7**  &nbsp;&nbsp; `9 stars today`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **无** &nbsp;&nbsp; stars: **109,807** &nbsp;&nbsp; folks: **36,778**  &nbsp;&nbsp; `299 stars today`

1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,618** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `152 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **118,688** &nbsp;&nbsp; folks: **16,944**  &nbsp;&nbsp; `179 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,795** &nbsp;&nbsp; folks: **1,386**  &nbsp;&nbsp; `1,870 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,192** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `2,427 stars this week`
...
1. [elixir-nx / livebook](https://github.com/elixir-nx/livebook)
    ...
    - language: **Elixir** &nbsp;&nbsp; stars: **1,259** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `773 stars this week`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,612** &nbsp;&nbsp; folks: **882**  &nbsp;&nbsp; `711 stars this week`
...
1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **2,564** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `361 stars this week`

1. [google / leveldb](https://github.com/google/leveldb)
    - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
    - language: **C++** &nbsp;&nbsp; stars: **24,397** &nbsp;&nbsp; folks: **5,513**  &nbsp;&nbsp; `334 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **15,411** &nbsp;&nbsp; folks: **314**  &nbsp;&nbsp; `654 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,391** &nbsp;&nbsp; folks: **7,939**  &nbsp;&nbsp; `1,676 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,618** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `212 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **73,420** &nbsp;&nbsp; folks: **6,618**  &nbsp;&nbsp; `253 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,819** &nbsp;&nbsp; folks: **4,794**  &nbsp;&nbsp; `493 stars this week`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,734** &nbsp;&nbsp; folks: **965**  &nbsp;&nbsp; `1,219 stars this month`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,352** &nbsp;&nbsp; folks: **3,097**  &nbsp;&nbsp; `214 stars this month`
