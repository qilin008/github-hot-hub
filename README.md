...
`更新时间：2021-05-25 03:30:31 +0800`

## 今日热门仓库

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,440** &nbsp;&nbsp; folks: **1,948**  &nbsp;&nbsp; `429 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **3,176** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `220 stars today`
...
1. [cdr / code-server](https://github.com/cdr/code-server)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,512** &nbsp;&nbsp; folks: **3,457**  &nbsp;&nbsp; `202 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **132,527** &nbsp;&nbsp; folks: **24,084**  &nbsp;&nbsp; `205 stars today`
...
1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,705** &nbsp;&nbsp; folks: **1,327**  &nbsp;&nbsp; `190 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,747** &nbsp;&nbsp; folks: **377**  &nbsp;&nbsp; `133 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,622** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `536 stars today`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,909** &nbsp;&nbsp; folks: **689**  &nbsp;&nbsp; `382 stars today`
...
1. [Pierian-Data / Complete-Python-3-Bootcamp](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,894** &nbsp;&nbsp; folks: **55,580**  &nbsp;&nbsp; `17 stars today`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,840** &nbsp;&nbsp; folks: **1,055**  &nbsp;&nbsp; `307 stars today`
...
1. [fireship-io / threejs-scroll-animation-demo](https://github.com/fireship-io/threejs-scroll-animation-demo)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **285** &nbsp;&nbsp; folks: **44**  &nbsp;&nbsp; `128 stars today`

1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    - Facebook AI Research Sequence-to-Sequence Toolkit written in Python.
    - language: **Python** &nbsp;&nbsp; stars: **12,656** &nbsp;&nbsp; folks: **3,177**  &nbsp;&nbsp; `143 stars today`

1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,814** &nbsp;&nbsp; folks: **10,035**  &nbsp;&nbsp; `77 stars today`
...
1. [saadeghi / daisyui](https://github.com/saadeghi/daisyui)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **876** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `96 stars today`
...
1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,023** &nbsp;&nbsp; folks: **783**  &nbsp;&nbsp; `47 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,607** &nbsp;&nbsp; folks: **1,711**  &nbsp;&nbsp; `169 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **67,041** &nbsp;&nbsp; folks: **21,067**  &nbsp;&nbsp; `1,000 stars this week`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,004** &nbsp;&nbsp; folks: **2,193**  &nbsp;&nbsp; `529 stars this week`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,440** &nbsp;&nbsp; folks: **1,948**  &nbsp;&nbsp; `1,578 stars this week`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    - A lightweight RTSP/RTMP/HTTP/HLS/HTTP-FLV/WebSocket-FLV/HTTP-TS/HTTP-fMP4/WebSocket-TS/WebSocket-fMP4/GB28181/WebRTC server and client framework based on C++11
    - language: **C++** &nbsp;&nbsp; stars: **3,840** &nbsp;&nbsp; folks: **1,055**  &nbsp;&nbsp; `693 stars this week`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **3,176** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `915 stars this week`

1. [makenotion / notion-sdk-js](https://github.com/makenotion/notion-sdk-js)
    - Official Notion JavaScript Client
    - language: **TypeScript** &nbsp;&nbsp; stars: **960** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `257 stars this week`

1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,668** &nbsp;&nbsp; folks: **1,954**  &nbsp;&nbsp; `345 stars this week`

1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,400** &nbsp;&nbsp; folks: **3,261**  &nbsp;&nbsp; `652 stars this week`

1. [vinta / awesome-python](https://github.com/vinta/awesome-python)
    - A curated list of awesome Python frameworks, libraries, software and resources
    - language: **Python** &nbsp;&nbsp; stars: **98,778** &nbsp;&nbsp; folks: **19,145**  &nbsp;&nbsp; `703 stars this week`

1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,814** &nbsp;&nbsp; folks: **10,035**  &nbsp;&nbsp; `240 stars this week`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,498** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `115 stars this week`
...
1. [tensorflow / tfjs-models](https://github.com/tensorflow/tfjs-models)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,055** &nbsp;&nbsp; folks: **2,806**  &nbsp;&nbsp; `88 stars this week`
...
1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,403** &nbsp;&nbsp; folks: **327**  &nbsp;&nbsp; `2,096 stars this month`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **10,478** &nbsp;&nbsp; folks: **1,887**  &nbsp;&nbsp; `3,696 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,350** &nbsp;&nbsp; folks: **8,276**  &nbsp;&nbsp; `3,614 stars this month`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **66,264** &nbsp;&nbsp; folks: **6,549**  &nbsp;&nbsp; `2,941 stars this month`
