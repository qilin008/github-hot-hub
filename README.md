...
`更新时间：2021-05-23 05:09:56 +0800`

## 今日热门仓库

1. [minio / minio](https://github.com/minio/minio)
    - High Performance, Kubernetes Native Object Storage
    - language: **Go** &nbsp;&nbsp; stars: **27,737** &nbsp;&nbsp; folks: **3,009**  &nbsp;&nbsp; `101 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,418** &nbsp;&nbsp; folks: **7,514**  &nbsp;&nbsp; `135 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,547** &nbsp;&nbsp; folks: **374**  &nbsp;&nbsp; `194 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,639** &nbsp;&nbsp; folks: **44**  &nbsp;&nbsp; `958 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,776** &nbsp;&nbsp; folks: **1,867**  &nbsp;&nbsp; `442 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,297** &nbsp;&nbsp; folks: **1,693**  &nbsp;&nbsp; `244 stars today`

1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    - Facebook AI Research Sequence-to-Sequence Toolkit written in Python.
    - language: **Python** &nbsp;&nbsp; stars: **12,376** &nbsp;&nbsp; folks: **3,157**  &nbsp;&nbsp; `251 stars today`

1. [Aayush9029 / Native-Youtube](https://github.com/Aayush9029/Native-Youtube)
    - Personal APp
    - language: **Swift** &nbsp;&nbsp; stars: **125** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `45 stars today`

1. [juce-framework / JUCE](https://github.com/juce-framework/JUCE)
    - JUCE is an open-source cross-platform C++ application framework for desktop and mobile applications, including VST, VST3, AU, AUv3, RTAS and AAX audio plug-ins.
    - language: **C++** &nbsp;&nbsp; stars: **2,969** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `70 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,356** &nbsp;&nbsp; folks: **675**  &nbsp;&nbsp; `284 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **120,927** &nbsp;&nbsp; folks: **17,231**  &nbsp;&nbsp; `149 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,512** &nbsp;&nbsp; folks: **865**  &nbsp;&nbsp; `145 stars today`

1. [lyswhut / lx-music-mobile](https://github.com/lyswhut/lx-music-mobile)
    - 一个基于 React native 开发的音乐软件。
    - language: **JavaScript** &nbsp;&nbsp; stars: **186** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `58 stars today`

1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,693** &nbsp;&nbsp; folks: **10,015**  &nbsp;&nbsp; `87 stars today`

1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    - Awesome Docker Compose samples
    - language: **HTML** &nbsp;&nbsp; stars: **11,263** &nbsp;&nbsp; folks: **1,367**  &nbsp;&nbsp; `124 stars today`

1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **103,751** &nbsp;&nbsp; folks: **41,335**  &nbsp;&nbsp; `145 stars today`
...
1. [alfonsrv / impf-botpy](https://github.com/alfonsrv/impf-botpy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **89** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `37 stars today`

1. [hashicorp / vault](https://github.com/hashicorp/vault)
    - A tool for secrets management, encryption as a service, and privileged access management
    - language: **Go** &nbsp;&nbsp; stars: **20,929** &nbsp;&nbsp; folks: **2,913**  &nbsp;&nbsp; `202 stars today`
...
1. [golang / go](https://github.com/golang/go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **85,905** &nbsp;&nbsp; folks: **12,552**  &nbsp;&nbsp; `129 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,549** &nbsp;&nbsp; folks: **20,826**  &nbsp;&nbsp; `108 stars today`
...
1. [sonnysangha / Amazon-starter-template-nextjs](https://github.com/sonnysangha/Amazon-starter-template-nextjs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **68** &nbsp;&nbsp; folks: **15**  &nbsp;&nbsp; `33 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **66,975** &nbsp;&nbsp; folks: **21,047**  &nbsp;&nbsp; `1,178 stars this week`
...
1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,418** &nbsp;&nbsp; folks: **7,514**  &nbsp;&nbsp; `448 stars this week`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    - A lightweight RTSP/RTMP/HTTP/HLS/HTTP-FLV/WebSocket-FLV/HTTP-TS/HTTP-fMP4/WebSocket-TS/WebSocket-fMP4/GB28181/WebRTC server and client framework based on C++11
    - language: **C++** &nbsp;&nbsp; stars: **3,459** &nbsp;&nbsp; folks: **1,045**  &nbsp;&nbsp; `306 stars this week`
...
1. [qeeqbox / social-analyzer](https://github.com/qeeqbox/social-analyzer)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,780** &nbsp;&nbsp; folks: **478**  &nbsp;&nbsp; `74 stars this week`
...
1. [rwightman / pytorch-image-models](https://github.com/rwightman/pytorch-image-models)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,167** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `498 stars this week`
...
1. [ericaltendorf / plotman](https://github.com/ericaltendorf/plotman)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **791** &nbsp;&nbsp; folks: **222**  &nbsp;&nbsp; `144 stars this week`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **107,984** &nbsp;&nbsp; folks: **29,936**  &nbsp;&nbsp; `5,849 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,252** &nbsp;&nbsp; folks: **8,261**  &nbsp;&nbsp; `4,250 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **无** &nbsp;&nbsp; stars: **160,452** &nbsp;&nbsp; folks: **23,227**  &nbsp;&nbsp; `5,738 stars this month`
