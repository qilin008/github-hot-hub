...
1. [onnx / onnx](https://github.com/onnx/onnx)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **10,644** &nbsp;&nbsp; folks: **1,954**  &nbsp;&nbsp; `122 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,489** &nbsp;&nbsp; folks: **372**  &nbsp;&nbsp; `144 stars today`

1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,359** &nbsp;&nbsp; folks: **3,248**  &nbsp;&nbsp; `180 stars today`

1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,526** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `322 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,188** &nbsp;&nbsp; folks: **1,685**  &nbsp;&nbsp; `157 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,611** &nbsp;&nbsp; folks: **1,852**  &nbsp;&nbsp; `425 stars today`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,951** &nbsp;&nbsp; folks: **1,485**  &nbsp;&nbsp; `144 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,261** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `827 stars today`
...
1. [frappe / erpnext](https://github.com/frappe/erpnext)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,585** &nbsp;&nbsp; folks: **3,576**  &nbsp;&nbsp; `186 stars today`
...
1. [swar / Swar-Chia-Plot-Manager](https://github.com/swar/Swar-Chia-Plot-Manager)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **960** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `516 stars this week`

1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **66,956** &nbsp;&nbsp; folks: **21,045**  &nbsp;&nbsp; `1,157 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **38,354** &nbsp;&nbsp; folks: **3,065**  &nbsp;&nbsp; `1,480 stars this week`
...
1. [h5bp / html5-boilerplate](https://github.com/h5bp/html5-boilerplate)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **50,395** &nbsp;&nbsp; folks: **11,568**  &nbsp;&nbsp; `461 stars this week`
...
1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,526** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `1,684 stars this week`
...
1. [parcel-bundler / parcel](https://github.com/parcel-bundler/parcel)
    - 📦🚀 Blazing fast, zero configuration web application bundler
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,341** &nbsp;&nbsp; folks: **1,933**  &nbsp;&nbsp; `232 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,621** &nbsp;&nbsp; folks: **974**  &nbsp;&nbsp; `3,763 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **9,871** &nbsp;&nbsp; folks: **2,273**  &nbsp;&nbsp; `3,697 stars this month`

1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    - An operating system, but it only plays Tetris.
    - language: **C** &nbsp;&nbsp; stars: **3,165** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `2,327 stars this month`
...
1. [audacity / audacity](https://github.com/audacity/audacity)
    - Audio Editor
    - language: **C** &nbsp;&nbsp; stars: **5,232** &nbsp;&nbsp; folks: **1,100**  &nbsp;&nbsp; `1,188 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,218** &nbsp;&nbsp; folks: **8,254**  &nbsp;&nbsp; `4,385 stars this month`
...
1. [jklepatch / eattheblocks](https://github.com/jklepatch/eattheblocks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,011** &nbsp;&nbsp; folks: **928**  &nbsp;&nbsp; `369 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **无** &nbsp;&nbsp; stars: **160,396** &nbsp;&nbsp; folks: **23,216**  &nbsp;&nbsp; `5,722 stars this month`
