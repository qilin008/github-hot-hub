...
`更新时间：2021-04-25 04:14:23 +0800`

## 今日热门仓库

1. [eva-engine / eva.js](https://github.com/eva-engine/eva.js)
    - Eva.js is a front-end game engine specifically for creating interactive game projects.
    - language: **JavaScript** &nbsp;&nbsp; stars: **401** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `204 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **119,096** &nbsp;&nbsp; folks: **16,956**  &nbsp;&nbsp; `246 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,333** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `199 stars today`
...
1. [google / googletest](https://github.com/google/googletest)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **21,775** &nbsp;&nbsp; folks: **7,394**  &nbsp;&nbsp; `91 stars today`

1. [microsoft / wslg](https://github.com/microsoft/wslg)
    - Enabling the Windows Subsystem for Linux to include support for Wayland and X server related scenarios
    - language: **C++** &nbsp;&nbsp; stars: **1,592** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `626 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,932** &nbsp;&nbsp; folks: **20,737**  &nbsp;&nbsp; `95 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,949** &nbsp;&nbsp; folks: **7,962**  &nbsp;&nbsp; `423 stars today`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,134** &nbsp;&nbsp; folks: **645**  &nbsp;&nbsp; `501 stars today`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,101** &nbsp;&nbsp; folks: **86**  &nbsp;&nbsp; `612 stars today`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,686** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `469 stars today`

1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    - A list of awesome applications, software, tools and other materials for Linux distros.
    - language: **Python** &nbsp;&nbsp; stars: **15,311** &nbsp;&nbsp; folks: **1,578**  &nbsp;&nbsp; `189 stars today`
...
1. [ossu / computer-science](https://github.com/ossu/computer-science)
    ...
    - language: **无** &nbsp;&nbsp; stars: **81,852** &nbsp;&nbsp; folks: **11,665**  &nbsp;&nbsp; `305 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **238** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `180 stars today`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **183,750** &nbsp;&nbsp; folks: **41,702**  &nbsp;&nbsp; `374 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,704** &nbsp;&nbsp; folks: **4,068**  &nbsp;&nbsp; `187 stars today`
...
1. [josepholiveira / podcastr](https://github.com/josepholiveira/podcastr)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **123** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `85 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,544** &nbsp;&nbsp; folks: **455**  &nbsp;&nbsp; `2,404 stars this week`
...
1. [Netflix / consoleme](https://github.com/Netflix/consoleme)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,288** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `503 stars this week`

1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    - Highly customizable library for building interactive node-based UIs, editors, flow charts and diagrams
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,195** &nbsp;&nbsp; folks: **243**  &nbsp;&nbsp; `2,088 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,949** &nbsp;&nbsp; folks: **7,962**  &nbsp;&nbsp; `2,220 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,272** &nbsp;&nbsp; folks: **45,692**  &nbsp;&nbsp; `2,514 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,228** &nbsp;&nbsp; folks: **183**  &nbsp;&nbsp; `1,824 stars this week`
...
1. [jarun / nnn](https://github.com/jarun/nnn)
    ...
    - language: **C** &nbsp;&nbsp; stars: **11,209** &nbsp;&nbsp; folks: **442**  &nbsp;&nbsp; `360 stars this week`
...
1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,775** &nbsp;&nbsp; folks: **7,394**  &nbsp;&nbsp; `162 stars this week`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,434** &nbsp;&nbsp; folks: **5,514**  &nbsp;&nbsp; `1,207 stars this month`
