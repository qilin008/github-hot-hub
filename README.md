...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,383** &nbsp;&nbsp; folks: **375**  &nbsp;&nbsp; `538 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **1,089** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `298 stars today`
...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **635** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `219 stars today`

1. [birchb1024 / frangipanni](https://github.com/birchb1024/frangipanni)
    - Program to convert lines of text into a tree structure.
    - language: **Go** &nbsp;&nbsp; stars: **785** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `170 stars today`

1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **47,061** &nbsp;&nbsp; folks: **12,579**  &nbsp;&nbsp; `75 stars today`
...
1. [spring-projects-experimental / spring-authorization-server](https://github.com/spring-projects-experimental/spring-authorization-server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,772** &nbsp;&nbsp; folks: **327**  &nbsp;&nbsp; `43 stars today`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,530** &nbsp;&nbsp; folks: **235**  &nbsp;&nbsp; `190 stars today`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **810** &nbsp;&nbsp; folks: **1,068**  &nbsp;&nbsp; `159 stars today`

1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    - The Intuitive Vue Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,253** &nbsp;&nbsp; folks: **2,874**  &nbsp;&nbsp; `340 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,160** &nbsp;&nbsp; folks: **16,884**  &nbsp;&nbsp; `406 stars today`

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **47,855** &nbsp;&nbsp; folks: **4,839**  &nbsp;&nbsp; `90 stars today`

1. [gto76 / python-cheatsheet](https://github.com/gto76/python-cheatsheet)
    - Comprehensive Python Cheatsheet
    - language: **Python** &nbsp;&nbsp; stars: **21,056** &nbsp;&nbsp; folks: **3,963**  &nbsp;&nbsp; `221 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,854** &nbsp;&nbsp; folks: **1,504**  &nbsp;&nbsp; `172 stars today`

1. [mrdoob / three.js](https://github.com/mrdoob/three.js)
    - JavaScript 3D library.
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,068** &nbsp;&nbsp; folks: **27,154**  &nbsp;&nbsp; `192 stars today`
...
1. [harryheman / React-Total](https://github.com/harryheman/React-Total)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **690** &nbsp;&nbsp; folks: **113**  &nbsp;&nbsp; `40 stars today`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **7,024** &nbsp;&nbsp; folks: **791**  &nbsp;&nbsp; `1,106 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,160** &nbsp;&nbsp; folks: **16,884**  &nbsp;&nbsp; `2,586 stars this week`

1. [php / php-src](https://github.com/php/php-src)
    - The PHP Interpreter
    - language: **C** &nbsp;&nbsp; stars: **30,234** &nbsp;&nbsp; folks: **6,569**  &nbsp;&nbsp; `571 stars this week`
...
1. [denoland / deno](https://github.com/denoland/deno)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **73,927** &nbsp;&nbsp; folks: **3,880**  &nbsp;&nbsp; `376 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,530** &nbsp;&nbsp; folks: **235**  &nbsp;&nbsp; `557 stars this week`

1. [alibaba / nacos](https://github.com/alibaba/nacos)
    - an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
    - language: **Java** &nbsp;&nbsp; stars: **16,955** &nbsp;&nbsp; folks: **6,600**  &nbsp;&nbsp; `159 stars this week`
...
1. [SerenityOS / serenity](https://github.com/SerenityOS/serenity)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **9,859** &nbsp;&nbsp; folks: **872**  &nbsp;&nbsp; `271 stars this week`
...
1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    ...
    - language: **无** &nbsp;&nbsp; stars: **23,568** &nbsp;&nbsp; folks: **5,246**  &nbsp;&nbsp; `303 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,769** &nbsp;&nbsp; folks: **1,102**  &nbsp;&nbsp; `5,470 stars this month`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **7,024** &nbsp;&nbsp; folks: **791**  &nbsp;&nbsp; `3,850 stars this month`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - 🔎 Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **24,039** &nbsp;&nbsp; folks: **2,412**  &nbsp;&nbsp; `3,395 stars this month`
...
1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,879** &nbsp;&nbsp; folks: **5,437**  &nbsp;&nbsp; `1,785 stars this month`
...
1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **100,963** &nbsp;&nbsp; folks: **34,761**  &nbsp;&nbsp; `3,045 stars this month`
...
1. [quii / learn-go-with-tests](https://github.com/quii/learn-go-with-tests)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **13,800** &nbsp;&nbsp; folks: **1,734**  &nbsp;&nbsp; `905 stars this month`

1. [pyroscope-io / pyroscope](https://github.com/pyroscope-io/pyroscope)
    - 🔥 Continuous Profiling Platform 🔥 Debug performance issues down to a single line of code
    - language: **Go** &nbsp;&nbsp; stars: **3,270** &nbsp;&nbsp; folks: **122**  &nbsp;&nbsp; `2,062 stars this month`
