...
1. [Tencent / secguide](https://github.com/Tencent/secguide)
    - 面向开发人员梳理的代码安全指南
    - language: **无** &nbsp;&nbsp; stars: **2,599** &nbsp;&nbsp; folks: **343**  &nbsp;&nbsp; `852 stars today`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **4,659** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `262 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,610** &nbsp;&nbsp; folks: **257**  &nbsp;&nbsp; `31 stars today`

1. [alibaba / spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba)
    - Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
    - language: **Java** &nbsp;&nbsp; stars: **18,827** &nbsp;&nbsp; folks: **5,768**  &nbsp;&nbsp; `27 stars today`

1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    - Fig adds autocomplete to your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,228** &nbsp;&nbsp; folks: **222**  &nbsp;&nbsp; `359 stars today`
...
1. [AMAI-GmbH / AI-Expert-Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,233** &nbsp;&nbsp; folks: **1,011**  &nbsp;&nbsp; `259 stars today`
...
1. [bradtraversy / design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)
    ...
    - language: **无** &nbsp;&nbsp; stars: **28,914** &nbsp;&nbsp; folks: **6,694**  &nbsp;&nbsp; `186 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,497** &nbsp;&nbsp; folks: **3,493**  &nbsp;&nbsp; `45 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,947** &nbsp;&nbsp; folks: **722**  &nbsp;&nbsp; `480 stars today`

1. [kon9chunkit / GitHub-Chinese-Top-Charts](https://github.com/kon9chunkit/GitHub-Chinese-Top-Charts)
    - 🇨🇳 GitHub中文排行榜，帮助你发现高分优秀中文项目、更高效地吸收国人的优秀经验成果；榜单每周更新一次，敬请关注！
    - language: **Java** &nbsp;&nbsp; stars: **33,811** &nbsp;&nbsp; folks: **4,886**  &nbsp;&nbsp; `184 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **189,201** &nbsp;&nbsp; folks: **42,327**  &nbsp;&nbsp; `292 stars today`

1. [inoyna11 / jd28](https://github.com/inoyna11/jd28)
    - 无
    - language: **JavaScript** &nbsp;&nbsp; stars: **190** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `68 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **11,487** &nbsp;&nbsp; folks: **2,019**  &nbsp;&nbsp; `264 stars today`
...
1. [bee-san / pyWhat](https://github.com/bee-san/pyWhat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **499** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `222 stars today`
...
1. [cdr / code-server](https://github.com/cdr/code-server)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,144** &nbsp;&nbsp; folks: **3,489**  &nbsp;&nbsp; `219 stars today`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,947** &nbsp;&nbsp; folks: **722**  &nbsp;&nbsp; `2,062 stars this week`
...
1. [lyswhut / lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
    - 一个基于 electron 的音乐软件
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,856** &nbsp;&nbsp; folks: **2,097**  &nbsp;&nbsp; `346 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,610** &nbsp;&nbsp; folks: **257**  &nbsp;&nbsp; `112 stars this week`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,049** &nbsp;&nbsp; folks: **2,196**  &nbsp;&nbsp; `491 stars this week`
...
1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,439** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `1,594 stars this month`
