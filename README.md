...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **13,853** &nbsp;&nbsp; folks: **1,461**  &nbsp;&nbsp; `278 stars today`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,976** &nbsp;&nbsp; folks: **4,801**  &nbsp;&nbsp; `285 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,565** &nbsp;&nbsp; folks: **7,947**  &nbsp;&nbsp; `434 stars today`

1. [vitling / acid-banger](https://github.com/vitling/acid-banger)
    - The Endless Acid Banger
    - language: **TypeScript** &nbsp;&nbsp; stars: **780** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `241 stars today`
...
1. [CyberPunkMetalHead / Binance-News-Sentiment-Bot](https://github.com/CyberPunkMetalHead/Binance-News-Sentiment-Bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **867** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `148 stars today`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,928** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `172 stars today`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,704** &nbsp;&nbsp; folks: **542**  &nbsp;&nbsp; `355 stars today`

1. [ascoders / weekly](https://github.com/ascoders/weekly)
    - 前端精读周刊。帮你理解最前沿、实用的技术。
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,949** &nbsp;&nbsp; folks: **1,374**  &nbsp;&nbsp; `222 stars today`

1. [zellij-org / zellij](https://github.com/zellij-org/zellij)
    - A terminal workspace with batteries included
    - language: **Rust** &nbsp;&nbsp; stars: **1,711** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `720 stars today`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,666** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `152 stars today`
...
1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,134** &nbsp;&nbsp; folks: **1,575**  &nbsp;&nbsp; `248 stars today`
...
1. [CleverProgrammers / cp-disney-plus-clone](https://github.com/CleverProgrammers/cp-disney-plus-clone)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **119** &nbsp;&nbsp; folks: **45**  &nbsp;&nbsp; `71 stars today`
...
1. [AvaloniaUI / Avalonia](https://github.com/AvaloniaUI/Avalonia)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **11,137** &nbsp;&nbsp; folks: **991**  &nbsp;&nbsp; `93 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,133** &nbsp;&nbsp; folks: **395**  &nbsp;&nbsp; `169 stars today`
...
1. [NeuromatchAcademy / course-content-dl](https://github.com/NeuromatchAcademy/course-content-dl)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **102** &nbsp;&nbsp; folks: **7**  &nbsp;&nbsp; `35 stars today`

1. [torvalds / linux](https://github.com/torvalds/linux)
    - Linux kernel source tree
    - language: **无** &nbsp;&nbsp; stars: **109,894** &nbsp;&nbsp; folks: **36,784**  &nbsp;&nbsp; `295 stars today`

1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,662** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `133 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **118,890** &nbsp;&nbsp; folks: **16,948**  &nbsp;&nbsp; `352 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,303** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `2,490 stars this week`
...
1. [elixir-nx / livebook](https://github.com/elixir-nx/livebook)
    ...
    - language: **Elixir** &nbsp;&nbsp; stars: **1,268** &nbsp;&nbsp; folks: **58**  &nbsp;&nbsp; `562 stars this week`

1. [nasa / fprime](https://github.com/nasa/fprime)
    - F' - A flight software and embedded systems framework
    - language: **C++** &nbsp;&nbsp; stars: **7,666** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `764 stars this week`
...
1. [testerSunshine / 12306](https://github.com/testerSunshine/12306)
    - 12306智能刷票，订票
    - language: **Python** &nbsp;&nbsp; stars: **29,823** &nbsp;&nbsp; folks: **9,410**  &nbsp;&nbsp; `338 stars this week`
...
1. [qiurunze123 / miaosha](https://github.com/qiurunze123/miaosha)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,254** &nbsp;&nbsp; folks: **5,139**  &nbsp;&nbsp; `352 stars this week`
...
1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **2,573** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `361 stars this week`

1. [google / leveldb](https://github.com/google/leveldb)
    - LevelDB is a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
    - language: **C++** &nbsp;&nbsp; stars: **24,404** &nbsp;&nbsp; folks: **5,513**  &nbsp;&nbsp; `243 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **15,425** &nbsp;&nbsp; folks: **315**  &nbsp;&nbsp; `530 stars this week`
...
1. [xmrig / xmrig](https://github.com/xmrig/xmrig)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,546** &nbsp;&nbsp; folks: **2,111**  &nbsp;&nbsp; `152 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,565** &nbsp;&nbsp; folks: **7,947**  &nbsp;&nbsp; `1,724 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,662** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `301 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,704** &nbsp;&nbsp; folks: **542**  &nbsp;&nbsp; `1,275 stars this week`

1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **52,976** &nbsp;&nbsp; folks: **4,801**  &nbsp;&nbsp; `770 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **103,874** &nbsp;&nbsp; folks: **17,258**  &nbsp;&nbsp; `4,613 stars this month`
