...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,967** &nbsp;&nbsp; folks: **317**  &nbsp;&nbsp; `1,323 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **901** &nbsp;&nbsp; folks: **145**  &nbsp;&nbsp; `135 stars today`
...
1. [spring-projects-experimental / spring-authorization-server](https://github.com/spring-projects-experimental/spring-authorization-server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,717** &nbsp;&nbsp; folks: **320**  &nbsp;&nbsp; `7 stars today`
...
1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    ...
    - language: **无** &nbsp;&nbsp; stars: **703** &nbsp;&nbsp; folks: **1,051**  &nbsp;&nbsp; `72 stars today`

1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    - The Intuitive Vue Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,046** &nbsp;&nbsp; folks: **2,869**  &nbsp;&nbsp; `180 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **101,923** &nbsp;&nbsp; folks: **16,856**  &nbsp;&nbsp; `580 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,734** &nbsp;&nbsp; folks: **1,486**  &nbsp;&nbsp; `157 stars today`

1. [mrdoob / three.js](https://github.com/mrdoob/three.js)
    - JavaScript 3D library.
    - language: **JavaScript** &nbsp;&nbsp; stars: **68,864** &nbsp;&nbsp; folks: **27,147**  &nbsp;&nbsp; `48 stars today`
...
1. [harryheman / React-Total](https://github.com/harryheman/React-Total)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **669** &nbsp;&nbsp; folks: **106**  &nbsp;&nbsp; `46 stars today`
...
1. [lucidrains / deep-daze](https://github.com/lucidrains/deep-daze)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,636** &nbsp;&nbsp; folks: **166**  &nbsp;&nbsp; `1,753 stars this week`

1. [Uniswap / uniswap-v3-core](https://github.com/Uniswap/uniswap-v3-core)
    - 🦄 🦄 🦄 Core smart contracts of Uniswap v3
    - language: **TypeScript** &nbsp;&nbsp; stars: **493** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `283 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,939** &nbsp;&nbsp; folks: **767**  &nbsp;&nbsp; `1,103 stars this week`

1. [microsoft / calculator](https://github.com/microsoft/calculator)
    - Windows Calculator: A simple yet powerful calculator that ships with Windows
    - language: **C++** &nbsp;&nbsp; stars: **21,708** &nbsp;&nbsp; folks: **3,778**  &nbsp;&nbsp; `490 stars this week`
...
1. [carlospolop / privilege-escalation-awesome-scripts-suite](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,848** &nbsp;&nbsp; folks: **1,127**  &nbsp;&nbsp; `340 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **101,923** &nbsp;&nbsp; folks: **16,856**  &nbsp;&nbsp; `2,146 stars this week`
...
1. [denoland / deno](https://github.com/denoland/deno)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **73,896** &nbsp;&nbsp; folks: **3,874**  &nbsp;&nbsp; `367 stars this week`

1. [sveltejs / kit](https://github.com/sveltejs/kit)
    - A monorepo for SvelteKit and friends
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,529** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `554 stars this week`

1. [ChristianChiarulli / nvcode](https://github.com/ChristianChiarulli/nvcode)
    - Truly the Ultimate Neovim Config NVCode
    - language: **Lua** &nbsp;&nbsp; stars: **2,031** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `169 stars this week`

1. [istio / istio](https://github.com/istio/istio)
    - Connect, secure, control, and observe services.
    - language: **Go** &nbsp;&nbsp; stars: **26,522** &nbsp;&nbsp; folks: **5,247**  &nbsp;&nbsp; `89 stars this week`

1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,414** &nbsp;&nbsp; folks: **226**  &nbsp;&nbsp; `445 stars this week`

1. [alibaba / nacos](https://github.com/alibaba/nacos)
    - an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
    - language: **Java** &nbsp;&nbsp; stars: **16,941** &nbsp;&nbsp; folks: **6,595**  &nbsp;&nbsp; `158 stars this week`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,670** &nbsp;&nbsp; folks: **3,189**  &nbsp;&nbsp; `1,577 stars this week`
...
1. [livewire / livewire](https://github.com/livewire/livewire)
    ...
    - language: **Blade** &nbsp;&nbsp; stars: **10,520** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `262 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,100** &nbsp;&nbsp; folks: **7,767**  &nbsp;&nbsp; `378 stars this week`
...
1. [ppy / osu](https://github.com/ppy/osu)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,611** &nbsp;&nbsp; folks: **1,168**  &nbsp;&nbsp; `138 stars this week`

1. [AobingJava / JavaFamily](https://github.com/AobingJava/JavaFamily)
    - 【Java面试+Java学习指南】 一份涵盖大部分Java程序员所需要掌握的核心知识。
    - language: **无** &nbsp;&nbsp; stars: **23,544** &nbsp;&nbsp; folks: **5,242**  &nbsp;&nbsp; `305 stars this week`
...
1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,103** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `4,496 stars this month`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **6,939** &nbsp;&nbsp; folks: **767**  &nbsp;&nbsp; `3,740 stars this month`
...
1. [authelia / authelia](https://github.com/authelia/authelia)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,640** &nbsp;&nbsp; folks: **288**  &nbsp;&nbsp; `2,629 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **117,185** &nbsp;&nbsp; folks: **16,740**  &nbsp;&nbsp; `3,687 stars this month`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **7,921** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `1,634 stars this month`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,670** &nbsp;&nbsp; folks: **3,189**  &nbsp;&nbsp; `5,953 stars this month`
...
1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,029** &nbsp;&nbsp; folks: **9,845**  &nbsp;&nbsp; `1,553 stars this month`
