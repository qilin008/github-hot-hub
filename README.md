...
1. [bradtraversy / design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)
    ...
    - language: **无** &nbsp;&nbsp; stars: **29,070** &nbsp;&nbsp; folks: **6,705**  &nbsp;&nbsp; `248 stars today`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,999** &nbsp;&nbsp; folks: **3,505**  &nbsp;&nbsp; `368 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,257** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `510 stars today`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,961** &nbsp;&nbsp; folks: **2,022**  &nbsp;&nbsp; `1,764 stars this week`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **629** &nbsp;&nbsp; folks: **138**  &nbsp;&nbsp; `210 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - GoogleTest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **22,519** &nbsp;&nbsp; folks: **7,534**  &nbsp;&nbsp; `272 stars this week`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **3,019** &nbsp;&nbsp; folks: **1,083**  &nbsp;&nbsp; `680 stars this week`

1. [Chia-Network / pool-reference](https://github.com/Chia-Network/pool-reference)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **258** &nbsp;&nbsp; folks: **64**  &nbsp;&nbsp; `70 stars this week`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,257** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `2,235 stars this week`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,950** &nbsp;&nbsp; folks: **1,066**  &nbsp;&nbsp; `673 stars this week`
...
1. [lyswhut / lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
    - 一个基于 electron 的音乐软件
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,874** &nbsp;&nbsp; folks: **2,100**  &nbsp;&nbsp; `311 stars this week`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,925** &nbsp;&nbsp; folks: **385**  &nbsp;&nbsp; `587 stars this week`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,764** &nbsp;&nbsp; folks: **271**  &nbsp;&nbsp; `254 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,962** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `1,463 stars this week`
...
1. [beurtschipper / Depix](https://github.com/beurtschipper/Depix)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,058** &nbsp;&nbsp; folks: **2,195**  &nbsp;&nbsp; `392 stars this week`
...
1. [artf / grapesjs](https://github.com/artf/grapesjs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,279** &nbsp;&nbsp; folks: **2,517**  &nbsp;&nbsp; `81 stars this week`
...
1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,278** &nbsp;&nbsp; folks: **3,492**  &nbsp;&nbsp; `1,296 stars this week`
...
1. [audacity / audacity](https://github.com/audacity/audacity)
    - Audio Editor
    - language: **C** &nbsp;&nbsp; stars: **5,308** &nbsp;&nbsp; folks: **1,122**  &nbsp;&nbsp; `1,247 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **10,419** &nbsp;&nbsp; folks: **2,427**  &nbsp;&nbsp; `3,647 stars this month`
...
1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    - live video streaming server in golang
    - language: **Go** &nbsp;&nbsp; stars: **6,227** &nbsp;&nbsp; folks: **1,372**  &nbsp;&nbsp; `1,079 stars this month`
...
1. [project-chip / connectedhomeip](https://github.com/project-chip/connectedhomeip)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,532** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `341 stars this month`
...
1. [solana-labs / solana](https://github.com/solana-labs/solana)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **2,149** &nbsp;&nbsp; folks: **469**  &nbsp;&nbsp; `488 stars this month`

1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **67,211** &nbsp;&nbsp; folks: **21,105**  &nbsp;&nbsp; `1,733 stars this month`
...
1. [Uniswap / uniswap-interface](https://github.com/Uniswap/uniswap-interface)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,871** &nbsp;&nbsp; folks: **1,757**  &nbsp;&nbsp; `353 stars this month`
...
1. [apache / pulsar](https://github.com/apache/pulsar)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,673** &nbsp;&nbsp; folks: **2,096**  &nbsp;&nbsp; `881 stars this month`
