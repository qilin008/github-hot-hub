...
1. [google / googletest](https://github.com/google/googletest)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **22,347** &nbsp;&nbsp; folks: **7,510**  &nbsp;&nbsp; `94 stars today`

1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,628** &nbsp;&nbsp; folks: **1,951**  &nbsp;&nbsp; `108 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,463** &nbsp;&nbsp; folks: **372**  &nbsp;&nbsp; `120 stars today`

1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,321** &nbsp;&nbsp; folks: **3,247**  &nbsp;&nbsp; `145 stars today`

1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,463** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `192 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,153** &nbsp;&nbsp; folks: **1,682**  &nbsp;&nbsp; `121 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,556** &nbsp;&nbsp; folks: **1,843**  &nbsp;&nbsp; `331 stars today`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,940** &nbsp;&nbsp; folks: **1,485**  &nbsp;&nbsp; `140 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,128** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `669 stars today`
...
1. [microsoft / TypeScript](https://github.com/microsoft/TypeScript)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,170** &nbsp;&nbsp; folks: **9,350**  &nbsp;&nbsp; `170 stars today`

1. [facebookresearch / pytorchvideo](https://github.com/facebookresearch/pytorchvideo)
    - A deep learning library for video understanding research.
    - language: **Python** &nbsp;&nbsp; stars: **1,096** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `155 stars today`

1. [apache / spark](https://github.com/apache/spark)
    - Apache Spark - A unified analytics engine for large-scale data processing
    - language: **Scala** &nbsp;&nbsp; stars: **29,847** &nbsp;&nbsp; folks: **23,882**  &nbsp;&nbsp; `69 stars today`
...
1. [frappe / erpnext](https://github.com/frappe/erpnext)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,547** &nbsp;&nbsp; folks: **3,575**  &nbsp;&nbsp; `132 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **66,944** &nbsp;&nbsp; folks: **21,044**  &nbsp;&nbsp; `1,138 stars this week`
...
1. [CyberPunkMetalHead / Binance-volatility-trading-bot](https://github.com/CyberPunkMetalHead/Binance-volatility-trading-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,278** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `299 stars this week`
...
1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,463** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `1,645 stars this week`
...
1. [wisz2021 / jd_docker](https://github.com/wisz2021/jd_docker)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **1,366** &nbsp;&nbsp; folks: **758**  &nbsp;&nbsp; `325 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **10,397** &nbsp;&nbsp; folks: **1,877**  &nbsp;&nbsp; `3,748 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **9,833** &nbsp;&nbsp; folks: **2,268**  &nbsp;&nbsp; `3,724 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,203** &nbsp;&nbsp; folks: **8,252**  &nbsp;&nbsp; `4,370 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **188,349** &nbsp;&nbsp; folks: **42,186**  &nbsp;&nbsp; `5,400 stars this month`
...
1. [apache / pulsar](https://github.com/apache/pulsar)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,544** &nbsp;&nbsp; folks: **2,068**  &nbsp;&nbsp; `878 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **无** &nbsp;&nbsp; stars: **160,383** &nbsp;&nbsp; folks: **23,213**  &nbsp;&nbsp; `5,701 stars this month`
