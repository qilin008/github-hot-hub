...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,277** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `543 stars today`

1. [Datalux / Osintgram](https://github.com/Datalux/Osintgram)
    - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
    - language: **Python** &nbsp;&nbsp; stars: **1,033** &nbsp;&nbsp; folks: **157**  &nbsp;&nbsp; `297 stars today`
...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **569** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `221 stars today`
...
1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **47,036** &nbsp;&nbsp; folks: **12,574**  &nbsp;&nbsp; `75 stars today`
...
1. [spring-projects-experimental / spring-authorization-server](https://github.com/spring-projects-experimental/spring-authorization-server)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,753** &nbsp;&nbsp; folks: **323**  &nbsp;&nbsp; `43 stars today`

1. [DefinitelyTyped / DefinitelyTyped](https://github.com/DefinitelyTyped/DefinitelyTyped)
    - The repository for high quality TypeScript type definitions.
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,039** &nbsp;&nbsp; folks: **24,344**  &nbsp;&nbsp; `67 stars today`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,466** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `190 stars today`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **775** &nbsp;&nbsp; folks: **1,056**  &nbsp;&nbsp; `159 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,077** &nbsp;&nbsp; folks: **16,865**  &nbsp;&nbsp; `405 stars today`
...
1. [gto76 / python-cheatsheet](https://github.com/gto76/python-cheatsheet)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **20,962** &nbsp;&nbsp; folks: **3,955**  &nbsp;&nbsp; `221 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,810** &nbsp;&nbsp; folks: **1,494**  &nbsp;&nbsp; `158 stars today`
...
1. [catchorg / Catch2](https://github.com/catchorg/Catch2)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **12,976** &nbsp;&nbsp; folks: **2,181**  &nbsp;&nbsp; `46 stars today`
...
1. [olmps / memo](https://github.com/olmps/memo)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **408** &nbsp;&nbsp; folks: **12**  &nbsp;&nbsp; `98 stars today`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,968** &nbsp;&nbsp; folks: **775**  &nbsp;&nbsp; `1,105 stars this week`

1. [microsoft / calculator](https://github.com/microsoft/calculator)
    - Windows Calculator: A simple yet powerful calculator that ships with Windows
    - language: **C++** &nbsp;&nbsp; stars: **21,711** &nbsp;&nbsp; folks: **3,777**  &nbsp;&nbsp; `508 stars this week`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,077** &nbsp;&nbsp; folks: **16,865**  &nbsp;&nbsp; `2,516 stars this week`
...
1. [istio / istio](https://github.com/istio/istio)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **26,522** &nbsp;&nbsp; folks: **5,249**  &nbsp;&nbsp; `80 stars this week`

1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,466** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `498 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,137** &nbsp;&nbsp; folks: **7,771**  &nbsp;&nbsp; `403 stars this week`
...
1. [ppy / osu](https://github.com/ppy/osu)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **6,621** &nbsp;&nbsp; folks: **1,169**  &nbsp;&nbsp; `141 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,745** &nbsp;&nbsp; folks: **1,102**  &nbsp;&nbsp; `5,448 stars this month`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **6,968** &nbsp;&nbsp; folks: **775**  &nbsp;&nbsp; `3,795 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **117,199** &nbsp;&nbsp; folks: **16,748**  &nbsp;&nbsp; `3,690 stars this month`
...
1. [Snailclimb / JavaGuide](https://github.com/Snailclimb/JavaGuide)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **100,937** &nbsp;&nbsp; folks: **34,756**  &nbsp;&nbsp; `3,045 stars this month`
