...
`更新时间：2021-04-18 03:15:01 +0800`

## 今日热门仓库

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **5,665** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `442 stars today`

1. [calendso / calendso](https://github.com/calendso/calendso)
    - The open-source Calendly alternative.
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,691** &nbsp;&nbsp; folks: **96**  &nbsp;&nbsp; `658 stars today`
...
1. [ekzhang / graphics-workshop](https://github.com/ekzhang/graphics-workshop)
    ...
    - language: **GLSL** &nbsp;&nbsp; stars: **266** &nbsp;&nbsp; folks: **13**  &nbsp;&nbsp; `154 stars today`

1. [avboy1337 / 1195777-chrome0day](https://github.com/avboy1337/1195777-chrome0day)
    - 无
    - language: **HTML** &nbsp;&nbsp; stars: **245** &nbsp;&nbsp; folks: **89**  &nbsp;&nbsp; `91 stars today`
...
1. [louisfb01 / start-machine-learning-in-2020](https://github.com/louisfb01/start-machine-learning-in-2020)
    ...
    - language: **无** &nbsp;&nbsp; stars: **682** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `182 stars today`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **2,367** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `1,205 stars this week`

1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,851** &nbsp;&nbsp; folks: **2,341**  &nbsp;&nbsp; `1,002 stars this week`

1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,873** &nbsp;&nbsp; folks: **213**  &nbsp;&nbsp; `2,144 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **5,665** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `836 stars this week`
...
1. [openethereum / openethereum](https://github.com/openethereum/openethereum)
    - The fast, light, and robust client for the Ethereum mainnet.
    - language: **Rust** &nbsp;&nbsp; stars: **612** &nbsp;&nbsp; folks: **118**  &nbsp;&nbsp; `253 stars this week`
...
1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,305** &nbsp;&nbsp; folks: **3,073**  &nbsp;&nbsp; `74 stars this week`

1. [awesome-selfhosted / awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted)
    - A list of Free Software network services and web applications which can be hosted on your own servers
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,454** &nbsp;&nbsp; folks: **4,419**  &nbsp;&nbsp; `980 stars this week`
...
1. [apache / superset](https://github.com/apache/superset)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **38,031** &nbsp;&nbsp; folks: **7,187**  &nbsp;&nbsp; `1,249 stars this week`
...
1. [binance-chain / bsc](https://github.com/binance-chain/bsc)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **302** &nbsp;&nbsp; folks: **106**  &nbsp;&nbsp; `63 stars this week`
...
1. [geekcomputers / Python](https://github.com/geekcomputers/Python)
    - My Python Examples
    - language: **Python** &nbsp;&nbsp; stars: **22,337** &nbsp;&nbsp; folks: **9,925**  &nbsp;&nbsp; `1,713 stars this month`
