...
`更新时间：2021-04-25 07:13:46 +0800`

## 今日热门仓库

1. [eva-engine / eva.js](https://github.com/eva-engine/eva.js)
    - Eva.js is a front-end game engine specifically for creating interactive game projects.
    - language: **JavaScript** &nbsp;&nbsp; stars: **430** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `208 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **119,124** &nbsp;&nbsp; folks: **16,958**  &nbsp;&nbsp; `141 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,341** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `213 stars today`

1. [ueberdosis / tiptap](https://github.com/ueberdosis/tiptap)
    - The headless editor framework for web artisans.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,990** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `240 stars today`
...
1. [microsoft / wslg](https://github.com/microsoft/wslg)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,620** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `347 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,949** &nbsp;&nbsp; folks: **20,737**  &nbsp;&nbsp; `85 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,973** &nbsp;&nbsp; folks: **7,963**  &nbsp;&nbsp; `248 stars today`
...
1. [jdah / tetris-os](https://github.com/jdah/tetris-os)
    ...
    - language: **C** &nbsp;&nbsp; stars: **2,141** &nbsp;&nbsp; folks: **87**  &nbsp;&nbsp; `363 stars today`
...
1. [openkraken / kraken](https://github.com/openkraken/kraken)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,707** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `260 stars today`

1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    - A list of awesome applications, software, tools and other materials for Linux distros.
    - language: **Python** &nbsp;&nbsp; stars: **15,339** &nbsp;&nbsp; folks: **1,579**  &nbsp;&nbsp; `150 stars today`
...
1. [gh0stkey / Binary-Learning](https://github.com/gh0stkey/Binary-Learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **254** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `66 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **81,918** &nbsp;&nbsp; folks: **11,670**  &nbsp;&nbsp; `306 stars today`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **14,118** &nbsp;&nbsp; folks: **1,469**  &nbsp;&nbsp; `125 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **246** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `103 stars today`

1. [rrweb-io / rrweb](https://github.com/rrweb-io/rrweb)
    - record and replay the web
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,110** &nbsp;&nbsp; folks: **700**  &nbsp;&nbsp; `152 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **183,819** &nbsp;&nbsp; folks: **41,708**  &nbsp;&nbsp; `341 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,749** &nbsp;&nbsp; folks: **4,068**  &nbsp;&nbsp; `210 stars today`
...
1. [josepholiveira / podcastr](https://github.com/josepholiveira/podcastr)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **143** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `99 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,897** &nbsp;&nbsp; folks: **1,406**  &nbsp;&nbsp; `1,227 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,973** &nbsp;&nbsp; folks: **7,963**  &nbsp;&nbsp; `2,223 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,304** &nbsp;&nbsp; folks: **45,697**  &nbsp;&nbsp; `2,475 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **306** &nbsp;&nbsp; folks: **218**  &nbsp;&nbsp; `183 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    ...
    - language: **C** &nbsp;&nbsp; stars: **53,315** &nbsp;&nbsp; folks: **4,809**  &nbsp;&nbsp; `1,088 stars this week`
...
1. [github / docs](https://github.com/github/docs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,529** &nbsp;&nbsp; folks: **15,497**  &nbsp;&nbsp; `784 stars this week`
...
1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,785** &nbsp;&nbsp; folks: **7,394**  &nbsp;&nbsp; `166 stars this week`
