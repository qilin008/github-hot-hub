...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,884** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `1,353 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **101,845** &nbsp;&nbsp; folks: **16,843**  &nbsp;&nbsp; `583 stars today`
...
1. [jychp / cloudflare-bypass](https://github.com/jychp/cloudflare-bypass)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **154** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `58 stars today`

1. [merry75 / educative.io_courses](https://github.com/merry75/educative.io_courses)
    - this is downloadings of all educative.io free student subscription courses as pdf from GitHub student pack
    - language: **无** &nbsp;&nbsp; stars: **673** &nbsp;&nbsp; folks: **1,046**  &nbsp;&nbsp; `73 stars today`
...
1. [microsoft / Swin-Transformer](https://github.com/microsoft/Swin-Transformer)
    ...
    - language: **无** &nbsp;&nbsp; stars: **862** &nbsp;&nbsp; folks: **39**  &nbsp;&nbsp; `217 stars today`
...
1. [Asabeneh / 30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,706** &nbsp;&nbsp; folks: **1,479**  &nbsp;&nbsp; `160 stars today`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,370** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `123 stars today`
...
1. [CyberPunkMetalHead / bitcoin-bot-buy-if-elon-tweets](https://github.com/CyberPunkMetalHead/bitcoin-bot-buy-if-elon-tweets)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **274** &nbsp;&nbsp; folks: **36**  &nbsp;&nbsp; `89 stars today`

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **47,784** &nbsp;&nbsp; folks: **4,833**  &nbsp;&nbsp; `73 stars today`

1. [nccgroup / ScoutSuite](https://github.com/nccgroup/ScoutSuite)
    - Multi-Cloud Security Auditing Tool
    - language: **Python** &nbsp;&nbsp; stars: **2,977** &nbsp;&nbsp; folks: **425**  &nbsp;&nbsp; `55 stars today`
...
1. [lucidrains / deep-daze](https://github.com/lucidrains/deep-daze)
    - Simple command line tool for text to image generation using OpenAI's CLIP and Siren (Implicit neural representation network)
    - language: **Python** &nbsp;&nbsp; stars: **2,534** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `1,753 stars this week`
...
1. [microsoft / calculator](https://github.com/microsoft/calculator)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **21,703** &nbsp;&nbsp; folks: **3,778**  &nbsp;&nbsp; `490 stars this week`
...
1. [EleutherAI / gpt-neo](https://github.com/EleutherAI/gpt-neo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,865** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `636 stars this week`

1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    - 24 Lessons, 12 Weeks, Get Started as a Web Developer
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,658** &nbsp;&nbsp; folks: **3,183**  &nbsp;&nbsp; `1,843 stars this week`
...
1. [carlospolop / privilege-escalation-awesome-scripts-suite](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,841** &nbsp;&nbsp; folks: **1,126**  &nbsp;&nbsp; `335 stars this week`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **6,913** &nbsp;&nbsp; folks: **764**  &nbsp;&nbsp; `1,078 stars this week`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **101,845** &nbsp;&nbsp; folks: **16,843**  &nbsp;&nbsp; `2,146 stars this week`
...
1. [sveltejs / kit](https://github.com/sveltejs/kit)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,520** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `527 stars this week`

1. [php / php-src](https://github.com/php/php-src)
    - The PHP Interpreter
    - language: **C** &nbsp;&nbsp; stars: **30,126** &nbsp;&nbsp; folks: **6,564**  &nbsp;&nbsp; `470 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,688** &nbsp;&nbsp; folks: **1,098**  &nbsp;&nbsp; `5,393 stars this month`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,397** &nbsp;&nbsp; folks: **949**  &nbsp;&nbsp; `4,005 stars this month`

1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    - Experimental Nintendo Switch Emulator written in C#
    - language: **C#** &nbsp;&nbsp; stars: **6,913** &nbsp;&nbsp; folks: **764**  &nbsp;&nbsp; `3,744 stars this month`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - 🔎 Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **23,999** &nbsp;&nbsp; folks: **2,411**  &nbsp;&nbsp; `3,363 stars this month`
...
1. [spring-projects-experimental / spring-native](https://github.com/spring-projects-experimental/spring-native)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,613** &nbsp;&nbsp; folks: **170**  &nbsp;&nbsp; `612 stars this month`

1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被全球175所大学采用教学。
    - language: **Python** &nbsp;&nbsp; stars: **21,859** &nbsp;&nbsp; folks: **5,430**  &nbsp;&nbsp; `1,771 stars this month`

1. [stefan-jansen / machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading)
    - Code for Machine Learning for Algorithmic Trading, 2nd edition.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,658** &nbsp;&nbsp; folks: **1,143**  &nbsp;&nbsp; `1,743 stars this month`
...
1. [openjdk / jdk](https://github.com/openjdk/jdk)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,732** &nbsp;&nbsp; folks: **2,085**  &nbsp;&nbsp; `867 stars this month`

1. [iperov / DeepFaceLab](https://github.com/iperov/DeepFaceLab)
    - DeepFaceLab is the leading software for creating deepfakes.
    - language: **Python** &nbsp;&nbsp; stars: **25,582** &nbsp;&nbsp; folks: **5,724**  &nbsp;&nbsp; `2,034 stars this month`
...
1. [AliaksandrSiarohin / first-order-model](https://github.com/AliaksandrSiarohin/first-order-model)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,769** &nbsp;&nbsp; folks: **2,284**  &nbsp;&nbsp; `1,142 stars this month`

1. [microsoft / calculator](https://github.com/microsoft/calculator)
    - Windows Calculator: A simple yet powerful calculator that ships with Windows
    - language: **C++** &nbsp;&nbsp; stars: **21,703** &nbsp;&nbsp; folks: **3,778**  &nbsp;&nbsp; `678 stars this month`

1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    - 「企业级低代码平台」前后端分离架构SpringBoot 2.x，SpringCloud，Ant Design&Vue，Mybatis-plus，Shiro，JWT。强大的代码生成器让前后端代码一键生成，无需写任何代码! 引领新的开发模式OnlineCoding->代码生成->手工MERGE，帮助Java项目解决70%重复工作，让开发更关注业务，既能快速提高效率，帮助公司节省成本，同时又不失灵活性。
    - language: **Java** &nbsp;&nbsp; stars: **21,339** &nbsp;&nbsp; folks: **8,237**  &nbsp;&nbsp; `1,580 stars this month`
