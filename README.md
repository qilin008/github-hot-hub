...
`更新时间：2021-05-01 04:11:53 +0800`

## 今日热门仓库

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,218** &nbsp;&nbsp; folks: **399**  &nbsp;&nbsp; `271 stars today`

1. [livewire / livewire](https://github.com/livewire/livewire)
    - A full-stack framework for Laravel that takes the pain out of building dynamic UIs.
    - language: **Blade** &nbsp;&nbsp; stars: **11,046** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `54 stars today`
...
1. [nextapps-de / winbox](https://github.com/nextapps-de/winbox)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,974** &nbsp;&nbsp; folks: **31**  &nbsp;&nbsp; `601 stars today`

1. [UnityTechnologies / open-project-1](https://github.com/UnityTechnologies/open-project-1)
    - Unity Open Project #1: Chop Chop
    - language: **C#** &nbsp;&nbsp; stars: **3,518** &nbsp;&nbsp; folks: **1,217**  &nbsp;&nbsp; `143 stars today`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **105,311** &nbsp;&nbsp; folks: **29,520**  &nbsp;&nbsp; `463 stars today`

1. [dani-garcia / vaultwarden](https://github.com/dani-garcia/vaultwarden)
    - Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs
    - language: **Rust** &nbsp;&nbsp; stars: **8,600** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `44 stars today`

1. [nvbn / thefuck](https://github.com/nvbn/thefuck)
    - Magnificent app which corrects your previous console command.
    - language: **Python** &nbsp;&nbsp; stars: **60,347** &nbsp;&nbsp; folks: **2,856**  &nbsp;&nbsp; `81 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **105,645** &nbsp;&nbsp; folks: **17,478**  &nbsp;&nbsp; `382 stars today`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **3,518** &nbsp;&nbsp; folks: **852**  &nbsp;&nbsp; `367 stars today`

1. [mlflow / mlflow](https://github.com/mlflow/mlflow)
    - Open source platform for the machine learning lifecycle
    - language: **Python** &nbsp;&nbsp; stars: **9,187** &nbsp;&nbsp; folks: **2,004**  &nbsp;&nbsp; `23 stars today`
...
1. [huggingface / datasets](https://github.com/huggingface/datasets)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,541** &nbsp;&nbsp; folks: **873**  &nbsp;&nbsp; `12 stars today`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,311** &nbsp;&nbsp; folks: **29,520**  &nbsp;&nbsp; `2,895 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **186,018** &nbsp;&nbsp; folks: **41,887**  &nbsp;&nbsp; `2,663 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,194** &nbsp;&nbsp; folks: **576**  &nbsp;&nbsp; `811 stars this week`

1. [Alamofire / Alamofire](https://github.com/Alamofire/Alamofire)
    - Elegant HTTP Networking in Swift
    - language: **Swift** &nbsp;&nbsp; stars: **35,645** &nbsp;&nbsp; folks: **6,670**  &nbsp;&nbsp; `72 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **73,740** &nbsp;&nbsp; folks: **8,065**  &nbsp;&nbsp; `1,073 stars this week`
...
1. [facebook / react-native](https://github.com/facebook/react-native)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,095** &nbsp;&nbsp; folks: **20,762**  &nbsp;&nbsp; `271 stars this week`
...
1. [rust-embedded / rust-raspberrypi-OS-tutorials](https://github.com/rust-embedded/rust-raspberrypi-OS-tutorials)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,246** &nbsp;&nbsp; folks: **243**  &nbsp;&nbsp; `692 stars this week`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **14,384** &nbsp;&nbsp; folks: **1,495**  &nbsp;&nbsp; `406 stars this week`
...
1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,883** &nbsp;&nbsp; folks: **672**  &nbsp;&nbsp; `1,463 stars this month`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **105,311** &nbsp;&nbsp; folks: **29,520**  &nbsp;&nbsp; `4,100 stars this month`
