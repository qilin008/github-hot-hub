...
`更新时间：2021-05-25 01:50:52 +0800`

## 今日热门仓库

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,421** &nbsp;&nbsp; folks: **1,947**  &nbsp;&nbsp; `460 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **3,158** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `212 stars today`

1. [utam0k / youki](https://github.com/utam0k/youki)
    - An experimental container runtime written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **581** &nbsp;&nbsp; folks: **29**  &nbsp;&nbsp; `88 stars today`

1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **43,495** &nbsp;&nbsp; folks: **3,458**  &nbsp;&nbsp; `313 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **132,516** &nbsp;&nbsp; folks: **24,085**  &nbsp;&nbsp; `141 stars today`

1. [juce-framework / JUCE](https://github.com/juce-framework/JUCE)
    - JUCE is an open-source cross-platform C++ application framework for desktop and mobile applications, including VST, VST3, AU, AUv3, RTAS and AAX audio plug-ins.
    - language: **C++** &nbsp;&nbsp; stars: **3,165** &nbsp;&nbsp; folks: **978**  &nbsp;&nbsp; `139 stars today`

1. [gwuhaolin / livego](https://github.com/gwuhaolin/livego)
    - live video streaming server in golang
    - language: **Go** &nbsp;&nbsp; stars: **5,693** &nbsp;&nbsp; folks: **1,327**  &nbsp;&nbsp; `232 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,740** &nbsp;&nbsp; folks: **377**  &nbsp;&nbsp; `150 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,583** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `577 stars today`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,888** &nbsp;&nbsp; folks: **688**  &nbsp;&nbsp; `398 stars today`

1. [discordjs / discord.js](https://github.com/discordjs/discord.js)
    - A powerful JavaScript library for interacting with the Discord API
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,540** &nbsp;&nbsp; folks: **2,445**  &nbsp;&nbsp; `19 stars today`
...
1. [ethereumbook / ethereumbook](https://github.com/ethereumbook/ethereumbook)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,741** &nbsp;&nbsp; folks: **2,342**  &nbsp;&nbsp; `19 stars today`
...
1. [CyberPunkMetalHead / Binance-volatility-trading-bot](https://github.com/CyberPunkMetalHead/Binance-volatility-trading-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,509** &nbsp;&nbsp; folks: **260**  &nbsp;&nbsp; `180 stars today`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,834** &nbsp;&nbsp; folks: **1,055**  &nbsp;&nbsp; `223 stars today`
...
1. [fireship-io / threejs-scroll-animation-demo](https://github.com/fireship-io/threejs-scroll-animation-demo)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **279** &nbsp;&nbsp; folks: **44**  &nbsp;&nbsp; `116 stars today`

1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    - Facebook AI Research Sequence-to-Sequence Toolkit written in Python.
    - language: **Python** &nbsp;&nbsp; stars: **12,648** &nbsp;&nbsp; folks: **3,177**  &nbsp;&nbsp; `172 stars today`
...
1. [home-assistant / core](https://github.com/home-assistant/core)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **43,034** &nbsp;&nbsp; folks: **14,079**  &nbsp;&nbsp; `25 stars today`

1. [saadeghi / daisyui](https://github.com/saadeghi/daisyui)
    - ⭐️ ⭐️ ⭐️ ⭐️ ⭐️  Tailwind Components
    - language: **Vue** &nbsp;&nbsp; stars: **844** &nbsp;&nbsp; folks: **34**  &nbsp;&nbsp; `96 stars today`
...
1. [willmcgugan / rich](https://github.com/willmcgugan/rich)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,008** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `46 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,598** &nbsp;&nbsp; folks: **1,710**  &nbsp;&nbsp; `234 stars today`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,421** &nbsp;&nbsp; folks: **1,947**  &nbsp;&nbsp; `1,404 stars this week`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **10,091** &nbsp;&nbsp; folks: **2,324**  &nbsp;&nbsp; `3,645 stars this month`

1. [audacity / audacity](https://github.com/audacity/audacity)
    - Audio Editor
    - language: **C** &nbsp;&nbsp; stars: **5,255** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `1,202 stars this month`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **108,116** &nbsp;&nbsp; folks: **29,964**  &nbsp;&nbsp; `5,881 stars this month`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **66,260** &nbsp;&nbsp; folks: **6,549**  &nbsp;&nbsp; `2,965 stars this month`
