...
1. [Tencent / secguide](https://github.com/Tencent/secguide)
    - 面向开发人员梳理的代码安全指南
    - language: **无** &nbsp;&nbsp; stars: **2,574** &nbsp;&nbsp; folks: **343**  &nbsp;&nbsp; `852 stars today`
...
1. [doocs / leetcode](https://github.com/doocs/leetcode)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **4,650** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `262 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,600** &nbsp;&nbsp; folks: **256**  &nbsp;&nbsp; `31 stars today`
...
1. [AMAI-GmbH / AI-Expert-Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,213** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `259 stars today`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **23,469** &nbsp;&nbsp; folks: **3,491**  &nbsp;&nbsp; `45 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,920** &nbsp;&nbsp; folks: **721**  &nbsp;&nbsp; `480 stars today`

1. [kon9chunkit / GitHub-Chinese-Top-Charts](https://github.com/kon9chunkit/GitHub-Chinese-Top-Charts)
    - 🇨🇳 GitHub中文排行榜，帮助你发现高分优秀中文项目、更高效地吸收国人的优秀经验成果；榜单每周更新一次，敬请关注！
    - language: **Java** &nbsp;&nbsp; stars: **33,788** &nbsp;&nbsp; folks: **4,884**  &nbsp;&nbsp; `184 stars today`
...
1. [bee-san / pyWhat](https://github.com/bee-san/pyWhat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **488** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `222 stars today`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,932** &nbsp;&nbsp; folks: **2,019**  &nbsp;&nbsp; `1,970 stars this week`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,920** &nbsp;&nbsp; folks: **721**  &nbsp;&nbsp; `2,051 stars this week`
...
1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,634** &nbsp;&nbsp; folks: **1,716**  &nbsp;&nbsp; `490 stars this week`

1. [lyswhut / lx-music-desktop](https://github.com/lyswhut/lx-music-desktop)
    - 一个基于 electron 的音乐软件
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,855** &nbsp;&nbsp; folks: **2,096**  &nbsp;&nbsp; `345 stars this week`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,895** &nbsp;&nbsp; folks: **383**  &nbsp;&nbsp; `587 stars this week`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,600** &nbsp;&nbsp; folks: **256**  &nbsp;&nbsp; `104 stars this week`

1. [sqlfluff / sqlfluff](https://github.com/sqlfluff/sqlfluff)
    - A SQL linter and auto-formatter for Humans
    - language: **Python** &nbsp;&nbsp; stars: **1,486** &nbsp;&nbsp; folks: **109**  &nbsp;&nbsp; `256 stars this week`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **3,917** &nbsp;&nbsp; folks: **252**  &nbsp;&nbsp; `1,459 stars this week`
...
1. [CyberPunkMetalHead / Binance-volatility-trading-bot](https://github.com/CyberPunkMetalHead/Binance-volatility-trading-bot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,606** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `414 stars this week`
...
1. [frappe / erpnext](https://github.com/frappe/erpnext)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,726** &nbsp;&nbsp; folks: **3,603**  &nbsp;&nbsp; `344 stars this week`
...
1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,135** &nbsp;&nbsp; folks: **3,489**  &nbsp;&nbsp; `1,183 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,857** &nbsp;&nbsp; folks: **1,051**  &nbsp;&nbsp; `3,121 stars this month`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,439** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `1,647 stars this month`
...
1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    ...
    - language: **无** &nbsp;&nbsp; stars: **10,346** &nbsp;&nbsp; folks: **2,408**  &nbsp;&nbsp; `3,623 stars this month`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **67,183** &nbsp;&nbsp; folks: **21,096**  &nbsp;&nbsp; `1,728 stars this month`
...
1. [apache / pulsar](https://github.com/apache/pulsar)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,659** &nbsp;&nbsp; folks: **2,094**  &nbsp;&nbsp; `886 stars this month`
