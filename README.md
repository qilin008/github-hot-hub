...
`更新时间：2021-04-02 16:09:03 +0800`

## 今日热门仓库

1. [johnBuffer / AntSimulator](https://github.com/johnBuffer/AntSimulator)
    - Simple Ants simulator
    - language: **C++** &nbsp;&nbsp; stars: **408** &nbsp;&nbsp; folks: **43**  &nbsp;&nbsp; `168 stars today`
...
1. [tonarino / innernet](https://github.com/tonarino/innernet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,202** &nbsp;&nbsp; folks: **31**  &nbsp;&nbsp; `233 stars today`
...
1. [trungk18 / angular-spotify](https://github.com/trungk18/angular-spotify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **808** &nbsp;&nbsp; folks: **77**  &nbsp;&nbsp; `222 stars today`
...
1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,450** &nbsp;&nbsp; folks: **2,876**  &nbsp;&nbsp; `245 stars today`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **181,668** &nbsp;&nbsp; folks: **41,431**  &nbsp;&nbsp; `266 stars today`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **62,587** &nbsp;&nbsp; folks: **6,126**  &nbsp;&nbsp; `138 stars today`

1. [ansible / ansible](https://github.com/ansible/ansible)
    - Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy and maintain. Automate everything from code deployment to network configuration to cloud management, in a language that approaches plain English, using SSH, with no agents to install on remote systems. https://docs.ansible.com.
    - language: **Python** &nbsp;&nbsp; stars: **47,521** &nbsp;&nbsp; folks: **20,443**  &nbsp;&nbsp; `72 stars today`

1. [protocolbuffers / protobuf](https://github.com/protocolbuffers/protobuf)
    - Protocol Buffers - Google's data interchange format
    - language: **C++** &nbsp;&nbsp; stars: **47,160** &nbsp;&nbsp; folks: **12,583**  &nbsp;&nbsp; `101 stars today`
...
1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **102,280** &nbsp;&nbsp; folks: **16,909**  &nbsp;&nbsp; `2,646 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录验证、权限验证、Session会话、踢人下线、分布式会话、单点登录、OAuth2.0、记住我模式、模拟他人账号、临时身份切换、集成Redis、多账号认证体系、前后台分离模式、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成...
    - language: **Java** &nbsp;&nbsp; stars: **1,717** &nbsp;&nbsp; folks: **272**  &nbsp;&nbsp; `737 stars this week`
...
1. [nuxt / nuxt.js](https://github.com/nuxt/nuxt.js)
    - The Intuitive Vue Framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,450** &nbsp;&nbsp; folks: **2,876**  &nbsp;&nbsp; `931 stars this week`
...
1. [signalapp / Signal-iOS](https://github.com/signalapp/Signal-iOS)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **8,172** &nbsp;&nbsp; folks: **2,107**  &nbsp;&nbsp; `272 stars this week`
...
1. [alibaba / nacos](https://github.com/alibaba/nacos)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **16,981** &nbsp;&nbsp; folks: **6,608**  &nbsp;&nbsp; `173 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,845** &nbsp;&nbsp; folks: **1,111**  &nbsp;&nbsp; `5,541 stars this month`

1. [sickcodes / Docker-OSX](https://github.com/sickcodes/Docker-OSX)
    - Run Mac in a Docker! Run near native OSX-KVM in Docker! X11 Forwarding! CI/CD for OS X!
    - language: **Shell** &nbsp;&nbsp; stars: **13,241** &nbsp;&nbsp; folks: **579**  &nbsp;&nbsp; `4,620 stars this month`
...
1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,473** &nbsp;&nbsp; folks: **961**  &nbsp;&nbsp; `3,790 stars this month`
...
1. [d2l-ai / d2l-zh](https://github.com/d2l-ai/d2l-zh)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,908** &nbsp;&nbsp; folks: **5,442**  &nbsp;&nbsp; `1,805 stars this month`
...
1. [flutter / flutter](https://github.com/flutter/flutter)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **117,264** &nbsp;&nbsp; folks: **16,766**  &nbsp;&nbsp; `3,700 stars this month`
...
1. [stefan-jansen / machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,691** &nbsp;&nbsp; folks: **1,155**  &nbsp;&nbsp; `1,767 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,726** &nbsp;&nbsp; folks: **3,193**  &nbsp;&nbsp; `5,917 stars this month`
...
1. [chatwoot / chatwoot](https://github.com/chatwoot/chatwoot)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **8,769** &nbsp;&nbsp; folks: **858**  &nbsp;&nbsp; `1,766 stars this month`

1. [flutter / samples](https://github.com/flutter/samples)
    - A collection of Flutter examples and demos.
    - language: **Dart** &nbsp;&nbsp; stars: **9,521** &nbsp;&nbsp; folks: **3,625**  &nbsp;&nbsp; `464 stars this month`
...
1. [facebook / react](https://github.com/facebook/react)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **166,292** &nbsp;&nbsp; folks: **33,385**  &nbsp;&nbsp; `2,166 stars this month`
...
1. [getzola / zola](https://github.com/getzola/zola)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,615** &nbsp;&nbsp; folks: **473**  &nbsp;&nbsp; `1,403 stars this month`
...
1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **125,031** &nbsp;&nbsp; folks: **40,554**  &nbsp;&nbsp; `3,218 stars this month`
