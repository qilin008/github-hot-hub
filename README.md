...
`更新时间：2021-04-25 10:10:11 +0800`

## 今日热门仓库

1. [eva-engine / eva.js](https://github.com/eva-engine/eva.js)
    - Eva.js is a front-end game engine specifically for creating interactive game projects.
    - language: **JavaScript** &nbsp;&nbsp; stars: **461** &nbsp;&nbsp; folks: **20**  &nbsp;&nbsp; `198 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,386** &nbsp;&nbsp; folks: **477**  &nbsp;&nbsp; `166 stars today`

1. [ueberdosis / tiptap](https://github.com/ueberdosis/tiptap)
    - The headless editor framework for web artisans.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,037** &nbsp;&nbsp; folks: **986**  &nbsp;&nbsp; `293 stars today`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,794** &nbsp;&nbsp; folks: **7,394**  &nbsp;&nbsp; `68 stars today`

1. [microsoft / wslg](https://github.com/microsoft/wslg)
    - Enabling the Windows Subsystem for Linux to include support for Wayland and X server related scenarios
    - language: **C++** &nbsp;&nbsp; stars: **1,663** &nbsp;&nbsp; folks: **23**  &nbsp;&nbsp; `393 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **94,962** &nbsp;&nbsp; folks: **20,737**  &nbsp;&nbsp; `97 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,996** &nbsp;&nbsp; folks: **7,965**  &nbsp;&nbsp; `273 stars today`

1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,198** &nbsp;&nbsp; folks: **647**  &nbsp;&nbsp; `342 stars today`

1. [TixiaoShan / LVI-SAM](https://github.com/TixiaoShan/LVI-SAM)
    - LVI-SAM: Tightly-coupled Lidar-Visual-Inertial Odometry via Smoothing and Mapping
    - language: **C++** &nbsp;&nbsp; stars: **291** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `81 stars today`
...
1. [luong-komorebi / Awesome-Linux-Software](https://github.com/luong-komorebi/Awesome-Linux-Software)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,359** &nbsp;&nbsp; folks: **1,580**  &nbsp;&nbsp; `163 stars today`
...
1. [gh0stkey / Binary-Learning](https://github.com/gh0stkey/Binary-Learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **262** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `46 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **无** &nbsp;&nbsp; stars: **81,965** &nbsp;&nbsp; folks: **11,673**  &nbsp;&nbsp; `343 stars today`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **14,134** &nbsp;&nbsp; folks: **1,471**  &nbsp;&nbsp; `133 stars today`
...
1. [openvinotoolkit / openvino_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **259** &nbsp;&nbsp; folks: **24**  &nbsp;&nbsp; `115 stars today`

1. [rrweb-io / rrweb](https://github.com/rrweb-io/rrweb)
    - record and replay the web
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,147** &nbsp;&nbsp; folks: **701**  &nbsp;&nbsp; `188 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **无** &nbsp;&nbsp; stars: **183,894** &nbsp;&nbsp; folks: **41,714**  &nbsp;&nbsp; `412 stars today`

1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **4,096** &nbsp;&nbsp; folks: **594**  &nbsp;&nbsp; `237 stars today`

1. [RH12503 / triangula](https://github.com/RH12503/triangula)
    - Generate high-quality triangulated art from images.
    - language: **Go** &nbsp;&nbsp; stars: **1,775** &nbsp;&nbsp; folks: **27**  &nbsp;&nbsp; `685 stars today`
...
1. [PrestaShop / PrestaShop](https://github.com/PrestaShop/PrestaShop)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,802** &nbsp;&nbsp; folks: **4,068**  &nbsp;&nbsp; `280 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,905** &nbsp;&nbsp; folks: **1,406**  &nbsp;&nbsp; `1,230 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,204** &nbsp;&nbsp; folks: **244**  &nbsp;&nbsp; `2,094 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **4,096** &nbsp;&nbsp; folks: **594**  &nbsp;&nbsp; `1,664 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,996** &nbsp;&nbsp; folks: **7,965**  &nbsp;&nbsp; `2,247 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,237** &nbsp;&nbsp; folks: **186**  &nbsp;&nbsp; `1,511 stars this week`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    - Personal Photo Management powered by Go and Google TensorFlow
    - language: **Go** &nbsp;&nbsp; stars: **12,198** &nbsp;&nbsp; folks: **647**  &nbsp;&nbsp; `679 stars this week`
...
1. [UKPLab / sentence-transformers](https://github.com/UKPLab/sentence-transformers)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,834** &nbsp;&nbsp; folks: **912**  &nbsp;&nbsp; `112 stars this week`

1. [google / googletest](https://github.com/google/googletest)
    - Googletest - Google Testing and Mocking Framework
    - language: **C++** &nbsp;&nbsp; stars: **21,794** &nbsp;&nbsp; folks: **7,394**  &nbsp;&nbsp; `174 stars this week`
...
1. [zhangdaiscott / jeecg-boot](https://github.com/zhangdaiscott/jeecg-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **22,100** &nbsp;&nbsp; folks: **8,536**  &nbsp;&nbsp; `368 stars this week`
...
1. [Kethku / neovide](https://github.com/Kethku/neovide)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,516** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `1,311 stars this month`
