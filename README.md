...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,664** &nbsp;&nbsp; folks: **632**  &nbsp;&nbsp; `66 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,834** &nbsp;&nbsp; folks: **1,389**  &nbsp;&nbsp; `1,674 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,340** &nbsp;&nbsp; folks: **427**  &nbsp;&nbsp; `2,490 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,107** &nbsp;&nbsp; folks: **165**  &nbsp;&nbsp; `2,003 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,113** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `2,008 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,767** &nbsp;&nbsp; folks: **550**  &nbsp;&nbsp; `1,334 stars this week`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **165,073** &nbsp;&nbsp; folks: **45,636**  &nbsp;&nbsp; `2,345 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,035** &nbsp;&nbsp; folks: **4,801**  &nbsp;&nbsp; `770 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,620** &nbsp;&nbsp; folks: **7,948**  &nbsp;&nbsp; `1,724 stars this week`
...
1. [vectorizedio / redpanda](https://github.com/vectorizedio/redpanda)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **2,089** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `92 stars this week`

1. [CSSEGISandData / COVID-19](https://github.com/CSSEGISandData/COVID-19)
    - Novel Coronavirus (COVID-19) Cases, provided by JHU CSSE
    - language: **无** &nbsp;&nbsp; stars: **26,322** &nbsp;&nbsp; folks: **16,831**  &nbsp;&nbsp; `240 stars this week`
...
1. [tauri-apps / tauri](https://github.com/tauri-apps/tauri)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **15,433** &nbsp;&nbsp; folks: **315**  &nbsp;&nbsp; `530 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,680** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `301 stars this week`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,620** &nbsp;&nbsp; folks: **7,948**  &nbsp;&nbsp; `3,077 stars this month`
