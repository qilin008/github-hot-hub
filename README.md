...
`更新时间：2021-04-14 11:18:39 +0800`

## 今日热门仓库

1. [foxlet / macOS-Simple-KVM](https://github.com/foxlet/macOS-Simple-KVM)
    - Tools to set up a quick macOS VM in QEMU, accelerated by KVM.
    - language: **Shell** &nbsp;&nbsp; stars: **10,246** &nbsp;&nbsp; folks: **838**  &nbsp;&nbsp; `135 stars today`
...
1. [google / leveldb](https://github.com/google/leveldb)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **23,945** &nbsp;&nbsp; folks: **5,464**  &nbsp;&nbsp; `231 stars today`

1. [Layout-Parser / layout-parser](https://github.com/Layout-Parser/layout-parser)
    - A unified toolkit for Deep Learning Based Document Image Analysis
    - language: **Python** &nbsp;&nbsp; stars: **1,640** &nbsp;&nbsp; folks: **112**  &nbsp;&nbsp; `177 stars today`
...
1. [DidierRLopes / GamestonkTerminal](https://github.com/DidierRLopes/GamestonkTerminal)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,804** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `101 stars today`
...
1. [charmbracelet / lipgloss](https://github.com/charmbracelet/lipgloss)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,698** &nbsp;&nbsp; folks: **48**  &nbsp;&nbsp; `803 stars this week`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,517** &nbsp;&nbsp; folks: **2,265**  &nbsp;&nbsp; `690 stars this week`
...
1. [tailwindlabs / headlessui](https://github.com/tailwindlabs/headlessui)
    - Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,809** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `1,154 stars this week`
...
1. [archlinux / archinstall](https://github.com/archlinux/archinstall)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,264** &nbsp;&nbsp; folks: **61**  &nbsp;&nbsp; `286 stars this week`

1. [react-hook-form / react-hook-form](https://github.com/react-hook-form/react-hook-form)
    - 📋 React Hooks for forms validation (Web + React Native)
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,991** &nbsp;&nbsp; folks: **913**  &nbsp;&nbsp; `288 stars this week`
...
1. [apache / superset](https://github.com/apache/superset)
    - Apache Superset is a Data Visualization and Data Exploration Platform
    - language: **Python** &nbsp;&nbsp; stars: **37,798** &nbsp;&nbsp; folks: **7,163**  &nbsp;&nbsp; `1,555 stars this week`

1. [dromara / soul](https://github.com/dromara/soul)
    - High-Performance Java API Gateway
    - language: **Java** &nbsp;&nbsp; stars: **3,810** &nbsp;&nbsp; folks: **1,369**  &nbsp;&nbsp; `123 stars this week`
...
1. [oppia / oppia](https://github.com/oppia/oppia)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,140** &nbsp;&nbsp; folks: **1,861**  &nbsp;&nbsp; `822 stars this week`
...
1. [airbnb / javascript](https://github.com/airbnb/javascript)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **107,866** &nbsp;&nbsp; folks: **20,790**  &nbsp;&nbsp; `603 stars this week`
...
1. [bradtraversy / vanillawebprojects](https://github.com/bradtraversy/vanillawebprojects)
    - Mini projects built with HTML5, CSS & JavaScript. No frameworks or libraries
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,517** &nbsp;&nbsp; folks: **2,265**  &nbsp;&nbsp; `938 stars this month`
