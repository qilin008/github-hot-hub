...
1. [chartjs / Chart.js](https://github.com/chartjs/Chart.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **52,691** &nbsp;&nbsp; folks: **10,846**  &nbsp;&nbsp; `17 stars today`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **156,121** &nbsp;&nbsp; folks: **20,304**  &nbsp;&nbsp; `92 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **158,909** &nbsp;&nbsp; folks: **44,574**  &nbsp;&nbsp; `455 stars today`
...
1. [appsmithorg / appsmith](https://github.com/appsmithorg/appsmith)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,365** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `104 stars today`
...
1. [archlinux / archinstall](https://github.com/archlinux/archinstall)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **350** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `133 stars today`
...
1. [mytechnotalent / Reverse-Engineering](https://github.com/mytechnotalent/Reverse-Engineering)
    ...
    - language: **C** &nbsp;&nbsp; stars: **3,844** &nbsp;&nbsp; folks: **319**  &nbsp;&nbsp; `189 stars today`

1. [discordjs / discord.js](https://github.com/discordjs/discord.js)
    - A powerful JavaScript library for interacting with the Discord API
    - language: **JavaScript** &nbsp;&nbsp; stars: **10,498** &nbsp;&nbsp; folks: **2,219**  &nbsp;&nbsp; `23 stars today`

1. [jvns / dnspeep](https://github.com/jvns/dnspeep)
    - spy on the DNS queries your computer is making
    - language: **Rust** &nbsp;&nbsp; stars: **249** &nbsp;&nbsp; folks: **13**  &nbsp;&nbsp; `80 stars today`

1. [ytdl-org / youtube-dl](https://github.com/ytdl-org/youtube-dl)
    - Command-line program to download videos from YouTube.com and other video sites
    - language: **Python** &nbsp;&nbsp; stars: **92,323** &nbsp;&nbsp; folks: **4,521**  &nbsp;&nbsp; `78 stars today`
...
1. [itdevbooks / pdf](https://github.com/itdevbooks/pdf)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,993** &nbsp;&nbsp; folks: **1,627**  &nbsp;&nbsp; `279 stars today`
...
1. [NAalytics / Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273](https://github.com/NAalytics/Assemblies-of-putative-SARS-CoV2-spike-encoding-mRNA-sequences-for-vaccines-BNT-162b2-and-mRNA-1273)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,729** &nbsp;&nbsp; folks: **439**  &nbsp;&nbsp; `2,544 stars this week`
...
1. [dromara / sa-token](https://github.com/dromara/sa-token)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,769** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `763 stars this week`

1. [php / php-src](https://github.com/php/php-src)
    - The PHP Interpreter
    - language: **C** &nbsp;&nbsp; stars: **30,294** &nbsp;&nbsp; folks: **6,575**  &nbsp;&nbsp; `623 stars this week`

1. [catchorg / Catch2](https://github.com/catchorg/Catch2)
    - A modern, C++-native, header-only, test framework for unit-tests, TDD and BDD - using C++11, C++14, C++17 and later (or C++03 on the Catch1.x branch)
    - language: **C++** &nbsp;&nbsp; stars: **13,155** &nbsp;&nbsp; folks: **2,212**  &nbsp;&nbsp; `256 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,266** &nbsp;&nbsp; folks: **7,789**  &nbsp;&nbsp; `449 stars this week`
...
1. [gothinkster / realworld](https://github.com/gothinkster/realworld)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,300** &nbsp;&nbsp; folks: **4,997**  &nbsp;&nbsp; `593 stars this week`
...
1. [denoland / deno](https://github.com/denoland/deno)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **74,025** &nbsp;&nbsp; folks: **3,896**  &nbsp;&nbsp; `439 stars this week`
...
1. [appsmithorg / appsmith](https://github.com/appsmithorg/appsmith)
    - Use Appsmith to build and self-host your internal apps. Create UI that connects to any database or API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,365** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `311 stars this week`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **9,897** &nbsp;&nbsp; folks: **1,124**  &nbsp;&nbsp; `5,587 stars this month`
...
1. [openjdk / jdk](https://github.com/openjdk/jdk)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **8,794** &nbsp;&nbsp; folks: **2,106**  &nbsp;&nbsp; `898 stars this month`

1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    - 📚 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计、Java、Python、C++
    - language: **Java** &nbsp;&nbsp; stars: **125,094** &nbsp;&nbsp; folks: **40,583**  &nbsp;&nbsp; `3,183 stars this month`
