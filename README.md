...
1. [google / googletest](https://github.com/google/googletest)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **22,285** &nbsp;&nbsp; folks: **7,503**  &nbsp;&nbsp; `105 stars today`

1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,575** &nbsp;&nbsp; folks: **1,950**  &nbsp;&nbsp; `149 stars today`

1. [dotnet / maui](https://github.com/dotnet/maui)
    - .NET MAUI is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
    - language: **C#** &nbsp;&nbsp; stars: **9,369** &nbsp;&nbsp; folks: **368**  &nbsp;&nbsp; `22 stars today`

1. [covid19india / covid19india-react](https://github.com/covid19india/covid19india-react)
    - Tracking the impact of COVID-19 in India
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,221** &nbsp;&nbsp; folks: **3,243**  &nbsp;&nbsp; `102 stars today`

1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,239** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `212 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,378** &nbsp;&nbsp; folks: **818**  &nbsp;&nbsp; `84 stars today`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,372** &nbsp;&nbsp; folks: **1,819**  &nbsp;&nbsp; `347 stars today`

1. [benawad / dogehouse](https://github.com/benawad/dogehouse)
    - Taking voice conversations to the moon 🚀
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,884** &nbsp;&nbsp; folks: **1,481**  &nbsp;&nbsp; `152 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **741** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `463 stars today`
...
1. [ErickWendel / semana-javascript-expert04](https://github.com/ErickWendel/semana-javascript-expert04)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **585** &nbsp;&nbsp; folks: **98**  &nbsp;&nbsp; `119 stars today`

1. [microsoft / TypeScript](https://github.com/microsoft/TypeScript)
    - TypeScript is a superset of JavaScript that compiles to clean JavaScript output.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,024** &nbsp;&nbsp; folks: **9,347**  &nbsp;&nbsp; `36 stars today`
...
1. [jackfrued / Python-100-Days](https://github.com/jackfrued/Python-100-Days)
    - Python - 100天从新手到大师
    - language: **Python** &nbsp;&nbsp; stars: **103,631** &nbsp;&nbsp; folks: **41,309**  &nbsp;&nbsp; `81 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **66,889** &nbsp;&nbsp; folks: **21,039**  &nbsp;&nbsp; `262 stars today`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **9,759** &nbsp;&nbsp; folks: **2,256**  &nbsp;&nbsp; `163 stars today`
...
1. [yichahucha / surge](https://github.com/yichahucha/surge)
    - Some useful scripts.
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,575** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `17 stars today`
...
1. [iluwatar / java-design-patterns](https://github.com/iluwatar/java-design-patterns)
    - Design patterns implemented in Java
    - language: **Java** &nbsp;&nbsp; stars: **66,889** &nbsp;&nbsp; folks: **21,039**  &nbsp;&nbsp; `1,092 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **38,320** &nbsp;&nbsp; folks: **3,063**  &nbsp;&nbsp; `1,874 stars this week`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **431** &nbsp;&nbsp; folks: **101**  &nbsp;&nbsp; `222 stars this week`
...
1. [GitSquared / edex-ui](https://github.com/GitSquared/edex-ui)
    - A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,239** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `1,435 stars this week`

1. [dromara / sa-token](https://github.com/dromara/sa-token)
    - 这可能是史上功能最全的Java权限认证框架！目前已集成——登录认证、权限认证、分布式Session会话、微服务网关鉴权、单点登录、OAuth2.0、踢人下线、Redis集成、前后台分离、记住我模式、模拟他人账号、临时身份切换、账号封禁、多账号认证体系、注解式鉴权、路由拦截式鉴权、花式token生成、自动续签、同端互斥登录、会话治理、密码加密、jwt集成、Spring集成、WebFlux集成...
    - language: **Java** &nbsp;&nbsp; stars: **3,222** &nbsp;&nbsp; folks: **596**  &nbsp;&nbsp; `375 stars this week`

1. [qarmin / czkawka](https://github.com/qarmin/czkawka)
    - Multi functional app to find duplicates, empty folders, similar images etc.
    - language: **Rust** &nbsp;&nbsp; stars: **3,972** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `742 stars this week`
...
1. [nanocurrency / nano-node](https://github.com/nanocurrency/nano-node)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,178** &nbsp;&nbsp; folks: **702**  &nbsp;&nbsp; `47 stars this week`
...
1. [onnx / onnx](https://github.com/onnx/onnx)
    - Open standard for machine learning interoperability
    - language: **C++** &nbsp;&nbsp; stars: **10,575** &nbsp;&nbsp; folks: **1,950**  &nbsp;&nbsp; `262 stars this week`

1. [wisz2021 / jd_docker](https://github.com/wisz2021/jd_docker)
    - 借用的github账号，仅用查看环境变量文档与教程，反馈issue使用。By lxk0301
    - language: **Shell** &nbsp;&nbsp; stars: **1,351** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `328 stars this week`
...
1. [ant-design / ant-design](https://github.com/ant-design/ant-design)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,436** &nbsp;&nbsp; folks: **28,059**  &nbsp;&nbsp; `64,996 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,554** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `3,861 stars this month`
