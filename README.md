...
`更新时间：2021-05-23 12:27:09 +0800`

## 今日热门仓库

1. [minio / minio](https://github.com/minio/minio)
    - High Performance, Kubernetes Native Object Storage
    - language: **Go** &nbsp;&nbsp; stars: **27,780** &nbsp;&nbsp; folks: **3,010**  &nbsp;&nbsp; `148 stars today`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **9,576** &nbsp;&nbsp; folks: **374**  &nbsp;&nbsp; `230 stars today`
...
1. [mehdihadeli / awesome-software-architecture](https://github.com/mehdihadeli/awesome-software-architecture)
    ...
    - language: **无** &nbsp;&nbsp; stars: **1,776** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `1,074 stars today`

1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    - Collection of publicly available IPTV channels from all over the world
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,844** &nbsp;&nbsp; folks: **1,876**  &nbsp;&nbsp; `491 stars today`
...
1. [ZLMediaKit / ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,512** &nbsp;&nbsp; folks: **1,047**  &nbsp;&nbsp; `94 stars today`
...
1. [ashishpatel26 / 500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code](https://github.com/ashishpatel26/500-AI-Machine-learning-Deep-learning-Computer-vision-NLP-Projects-with-code)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,349** &nbsp;&nbsp; folks: **1,696**  &nbsp;&nbsp; `305 stars today`

1. [pytorch / fairseq](https://github.com/pytorch/fairseq)
    - Facebook AI Research Sequence-to-Sequence Toolkit written in Python.
    - language: **Python** &nbsp;&nbsp; stars: **12,415** &nbsp;&nbsp; folks: **3,160**  &nbsp;&nbsp; `297 stars today`

1. [Aayush9029 / Native-Youtube](https://github.com/Aayush9029/Native-Youtube)
    - Personal APp
    - language: **Swift** &nbsp;&nbsp; stars: **141** &nbsp;&nbsp; folks: **25**  &nbsp;&nbsp; `54 stars today`

1. [juce-framework / JUCE](https://github.com/juce-framework/JUCE)
    - JUCE is an open-source cross-platform C++ application framework for desktop and mobile applications, including VST, VST3, AU, AUv3, RTAS and AAX audio plug-ins.
    - language: **C++** &nbsp;&nbsp; stars: **3,007** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `114 stars today`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,434** &nbsp;&nbsp; folks: **677**  &nbsp;&nbsp; `372 stars today`

1. [flutter / flutter](https://github.com/flutter/flutter)
    - Flutter makes it easy and fast to build beautiful apps for mobile and beyond.
    - language: **Dart** &nbsp;&nbsp; stars: **120,997** &nbsp;&nbsp; folks: **17,233**  &nbsp;&nbsp; `225 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **2,532** &nbsp;&nbsp; folks: **871**  &nbsp;&nbsp; `146 stars today`

1. [lyswhut / lx-music-mobile](https://github.com/lyswhut/lx-music-mobile)
    - 一个基于 React native 开发的音乐软件。
    - language: **JavaScript** &nbsp;&nbsp; stars: **199** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `68 stars today`
...
1. [docker / awesome-compose](https://github.com/docker/awesome-compose)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **11,310** &nbsp;&nbsp; folks: **1,368**  &nbsp;&nbsp; `179 stars today`
...
1. [alfonsrv / impf-botpy](https://github.com/alfonsrv/impf-botpy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **96** &nbsp;&nbsp; folks: **11**  &nbsp;&nbsp; `46 stars today`

1. [hashicorp / vault](https://github.com/hashicorp/vault)
    - A tool for secrets management, encryption as a service, and privileged access management
    - language: **Go** &nbsp;&nbsp; stars: **21,053** &nbsp;&nbsp; folks: **2,913**  &nbsp;&nbsp; `347 stars today`
...
1. [WeChat-Big-Data-Challenge-2021 / WeChat_Big_Data_Challenge](https://github.com/WeChat-Big-Data-Challenge-2021/WeChat_Big_Data_Challenge)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **150** &nbsp;&nbsp; folks: **41**  &nbsp;&nbsp; `42 stars today`

1. [golang / go](https://github.com/golang/go)
    - The Go programming language
    - language: **Go** &nbsp;&nbsp; stars: **85,960** &nbsp;&nbsp; folks: **12,553**  &nbsp;&nbsp; `190 stars today`

1. [facebook / react-native](https://github.com/facebook/react-native)
    - A framework for building native apps with React.
    - language: **JavaScript** &nbsp;&nbsp; stars: **95,583** &nbsp;&nbsp; folks: **20,825**  &nbsp;&nbsp; `134 stars today`
...
1. [sonnysangha / Amazon-starter-template-nextjs](https://github.com/sonnysangha/Amazon-starter-template-nextjs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **90** &nbsp;&nbsp; folks: **16**  &nbsp;&nbsp; `56 stars today`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,265** &nbsp;&nbsp; folks: **8,265**  &nbsp;&nbsp; `4,264 stars this month`
