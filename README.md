...
1. [google / zx](https://github.com/google/zx)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,759** &nbsp;&nbsp; folks: **197**  &nbsp;&nbsp; `9,843 stars this week`

1. [slidevjs / slidev](https://github.com/slidevjs/slidev)
    - Presentation Slides for Developers (Public Beta 🎉)
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,730** &nbsp;&nbsp; folks: **224**  &nbsp;&nbsp; `6,245 stars this week`

1. [swar / Swar-Chia-Plot-Manager](https://github.com/swar/Swar-Chia-Plot-Manager)
    - This is a Cross-Platform Plot Manager for Chia Plotting that is simple, easy-to-use, and reliable.
    - language: **Python** &nbsp;&nbsp; stars: **512** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `274 stars this week`
...
1. [abuanwar072 / Flutter-Responsive-Admin-Panel-or-Dashboard](https://github.com/abuanwar072/Flutter-Responsive-Admin-Panel-or-Dashboard)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **2,045** &nbsp;&nbsp; folks: **317**  &nbsp;&nbsp; `1,059 stars this week`
...
1. [pallupz / covid-vaccine-booking](https://github.com/pallupz/covid-vaccine-booking)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **474** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `202 stars this week`
...
1. [trustwallet / assets](https://github.com/trustwallet/assets)
    - A comprehensive, up-to-date collection of information about several thousands (!) of crypto tokens.
    - language: **TypeScript** &nbsp;&nbsp; stars: **935** &nbsp;&nbsp; folks: **4,968**  &nbsp;&nbsp; `291 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **9,636** &nbsp;&nbsp; folks: **1,778**  &nbsp;&nbsp; `1,306 stars this week`

1. [ossrs / srs](https://github.com/ossrs/srs)
    - SRS is a simple, high efficiency and realtime video server, supports RTMP/WebRTC/HLS/HTTP-FLV/SRT/GB28181.
    - language: **C++** &nbsp;&nbsp; stars: **13,463** &nbsp;&nbsp; folks: **3,772**  &nbsp;&nbsp; `1,537 stars this week`
...
1. [ericaltendorf / plotman](https://github.com/ericaltendorf/plotman)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **662** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `221 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **75,787** &nbsp;&nbsp; folks: **8,202**  &nbsp;&nbsp; `1,709 stars this week`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **9,636** &nbsp;&nbsp; folks: **1,778**  &nbsp;&nbsp; `4,736 stars this month`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,233** &nbsp;&nbsp; folks: **288**  &nbsp;&nbsp; `2,096 stars this month`

1. [calendso / calendso](https://github.com/calendso/calendso)
    - The open-source Calendly alternative.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,112** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `4,087 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **75,787** &nbsp;&nbsp; folks: **8,202**  &nbsp;&nbsp; `5,171 stars this month`
...
1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    ...
    - language: **无** &nbsp;&nbsp; stars: **169,600** &nbsp;&nbsp; folks: **46,548**  &nbsp;&nbsp; `7,367 stars this month`

1. [trustwallet / assets](https://github.com/trustwallet/assets)
    - A comprehensive, up-to-date collection of information about several thousands (!) of crypto tokens.
    - language: **TypeScript** &nbsp;&nbsp; stars: **935** &nbsp;&nbsp; folks: **4,968**  &nbsp;&nbsp; `452 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **124,138** &nbsp;&nbsp; folks: **15,132**  &nbsp;&nbsp; `7,052 stars this month`
...
1. [supabase / supabase](https://github.com/supabase/supabase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,495** &nbsp;&nbsp; folks: **513**  &nbsp;&nbsp; `4,888 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **187,848** &nbsp;&nbsp; folks: **42,115**  &nbsp;&nbsp; `5,261 stars this month`
