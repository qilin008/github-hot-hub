...
1. [CyC2018 / CS-Notes](https://github.com/CyC2018/CS-Notes)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **128,132** &nbsp;&nbsp; folks: **41,523**  &nbsp;&nbsp; `183 stars today`
...
1. [gto76 / python-cheatsheet](https://github.com/gto76/python-cheatsheet)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,599** &nbsp;&nbsp; folks: **4,247**  &nbsp;&nbsp; `467 stars today`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **22,654** &nbsp;&nbsp; folks: **3,404**  &nbsp;&nbsp; `542 stars today`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **75,233** &nbsp;&nbsp; folks: **8,165**  &nbsp;&nbsp; `541 stars today`
...
1. [tuvtran / project-based-learning](https://github.com/tuvtran/project-based-learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **49,096** &nbsp;&nbsp; folks: **7,725**  &nbsp;&nbsp; `168 stars today`
...
1. [CovidTrackerFr / vitemadose](https://github.com/CovidTrackerFr/vitemadose)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **125** &nbsp;&nbsp; folks: **40**  &nbsp;&nbsp; `44 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **2,039** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `191 stars today`
...
1. [alacritty / alacritty](https://github.com/alacritty/alacritty)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **32,460** &nbsp;&nbsp; folks: **1,671**  &nbsp;&nbsp; `1,349 stars this week`
...
1. [Uniswap / uniswap-interface](https://github.com/Uniswap/uniswap-interface)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,755** &nbsp;&nbsp; folks: **1,649**  &nbsp;&nbsp; `100 stars this week`
...
1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,802** &nbsp;&nbsp; folks: **839**  &nbsp;&nbsp; `5,583 stars this month`

1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **9,187** &nbsp;&nbsp; folks: **1,695**  &nbsp;&nbsp; `4,411 stars this month`

1. [chrisleekr / binance-trading-bot](https://github.com/chrisleekr/binance-trading-bot)
    - Automated Binance trading bot - Buy low/Sell high with stop loss limit/Trade multiple cryptocurrencies
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,188** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `2,074 stars this month`
...
1. [photoprism / photoprism](https://github.com/photoprism/photoprism)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **13,697** &nbsp;&nbsp; folks: **712**  &nbsp;&nbsp; `2,275 stars this month`

1. [DIGITALCRIMINAL / OnlyFans](https://github.com/DIGITALCRIMINAL/OnlyFans)
    - Scrape all the media from an OnlyFans account - Updated regularly
    - language: **Python** &nbsp;&nbsp; stars: **1,604** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `826 stars this month`
...
1. [openethereum / openethereum](https://github.com/openethereum/openethereum)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **814** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `451 stars this month`
...
1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **75,233** &nbsp;&nbsp; folks: **8,165**  &nbsp;&nbsp; `4,710 stars this month`

1. [lettier / 3d-game-shaders-for-beginners](https://github.com/lettier/3d-game-shaders-for-beginners)
    - 🎮 A step-by-step guide to implementing SSAO, depth of field, lighting, normal mapping, and more for your 3D game.
    - language: **C++** &nbsp;&nbsp; stars: **10,123** &nbsp;&nbsp; folks: **711**  &nbsp;&nbsp; `1,830 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **123,755** &nbsp;&nbsp; folks: **15,071**  &nbsp;&nbsp; `6,953 stars this month`

1. [Kethku / neovide](https://github.com/Kethku/neovide)
    - No Nonsense Neovim Client in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **3,937** &nbsp;&nbsp; folks: **150**  &nbsp;&nbsp; `1,229 stars this month`
...
1. [solana-labs / solana](https://github.com/solana-labs/solana)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,920** &nbsp;&nbsp; folks: **418**  &nbsp;&nbsp; `405 stars this month`

1. [opensearch-project / OpenSearch](https://github.com/opensearch-project/OpenSearch)
    - Open source distributed and RESTful search engine.
    - language: **Java** &nbsp;&nbsp; stars: **2,281** &nbsp;&nbsp; folks: **164**  &nbsp;&nbsp; `2,147 stars this month`

1. [supabase / supabase](https://github.com/supabase/supabase)
    - The open source Firebase alternative. Follow to stay updated about our public Beta.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,377** &nbsp;&nbsp; folks: **501**  &nbsp;&nbsp; `4,859 stars this month`

1. [trustwallet / assets](https://github.com/trustwallet/assets)
    - A comprehensive, up-to-date collection of information about several thousands (!) of crypto tokens.
    - language: **TypeScript** &nbsp;&nbsp; stars: **726** &nbsp;&nbsp; folks: **4,762**  &nbsp;&nbsp; `321 stars this month`

1. [youngyangyang04 / leetcode-master](https://github.com/youngyangyang04/leetcode-master)
    - LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，从此算法学习不再迷茫！🔥🔥 来看看，你会发现相见恨晚！🚀
    - language: **无** &nbsp;&nbsp; stars: **8,226** &nbsp;&nbsp; folks: **1,915**  &nbsp;&nbsp; `2,571 stars this month`

1. [ChristianChiarulli / LunarVim](https://github.com/ChristianChiarulli/LunarVim)
    - A Neovim config made with sane defaults
    - language: **Lua** &nbsp;&nbsp; stars: **2,839** &nbsp;&nbsp; folks: **643**  &nbsp;&nbsp; `697 stars this month`

1. [alacritty / alacritty](https://github.com/alacritty/alacritty)
    - A cross-platform, OpenGL terminal emulator.
    - language: **Rust** &nbsp;&nbsp; stars: **32,460** &nbsp;&nbsp; folks: **1,671**  &nbsp;&nbsp; `1,799 stars this month`
