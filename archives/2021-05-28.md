...
`最后更新时间：2021-05-28 00:49:31 +0800`
...
1. [wuyouzhuguli / SpringAll](https://github.com/wuyouzhuguli/SpringAll)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,174** &nbsp;&nbsp; folks: **6,058**  &nbsp;&nbsp; `143 stars today`

1. [doocs / leetcode](https://github.com/doocs/leetcode)
    - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
    - language: **Java** &nbsp;&nbsp; stars: **4,706** &nbsp;&nbsp; folks: **1,014**  &nbsp;&nbsp; `259 stars today`

1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,647** &nbsp;&nbsp; folks: **258**  &nbsp;&nbsp; `26 stars today`
...
1. [withfig / autocomplete](https://github.com/withfig/autocomplete)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,329** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `351 stars today`
...
1. [AMAI-GmbH / AI-Expert-Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **11,317** &nbsp;&nbsp; folks: **1,015**  &nbsp;&nbsp; `247 stars today`
...
1. [bradtraversy / design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)
    ...
    - language: **无** &nbsp;&nbsp; stars: **28,961** &nbsp;&nbsp; folks: **6,696**  &nbsp;&nbsp; `174 stars today`
...
1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,057** &nbsp;&nbsp; folks: **724**  &nbsp;&nbsp; `434 stars today`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **无** &nbsp;&nbsp; stars: **189,253** &nbsp;&nbsp; folks: **42,330**  &nbsp;&nbsp; `275 stars today`
...
1. [bee-san / pyWhat](https://github.com/bee-san/pyWhat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **560** &nbsp;&nbsp; folks: **17**  &nbsp;&nbsp; `252 stars today`
...
1. [tuvtran / project-based-learning](https://github.com/tuvtran/project-based-learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **50,401** &nbsp;&nbsp; folks: **7,853**  &nbsp;&nbsp; `70 stars today`

1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,169** &nbsp;&nbsp; folks: **3,490**  &nbsp;&nbsp; `217 stars today`
...
1. [ethersphere / bee](https://github.com/ethersphere/bee)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **614** &nbsp;&nbsp; folks: **135**  &nbsp;&nbsp; `208 stars this week`
...
1. [Chia-Network / pool-reference](https://github.com/Chia-Network/pool-reference)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **254** &nbsp;&nbsp; folks: **63**  &nbsp;&nbsp; `89 stars this week`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Appwrite is a secure end-to-end backend server for Web, Mobile, and Flutter developers that is packaged as a set of Docker containers for easy deployment 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **9,057** &nbsp;&nbsp; folks: **724**  &nbsp;&nbsp; `2,107 stars this week`
...
1. [airbytehq / airbyte](https://github.com/airbytehq/airbyte)
    - Airbyte is an open-source EL(T) platform that helps you replicate your data in your warehouses, lakes and databases.
    - language: **Java** &nbsp;&nbsp; stars: **2,647** &nbsp;&nbsp; folks: **258**  &nbsp;&nbsp; `117 stars this week`

1. [sqlfluff / sqlfluff](https://github.com/sqlfluff/sqlfluff)
    - A SQL linter and auto-formatter for Humans
    - language: **Python** &nbsp;&nbsp; stars: **1,503** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `256 stars this week`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - The best open source remote desktop client software
    - language: **Rust** &nbsp;&nbsp; stars: **3,931** &nbsp;&nbsp; folks: **252**  &nbsp;&nbsp; `1,459 stars this week`
...
1. [cdr / code-server](https://github.com/cdr/code-server)
    - VS Code in the browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,169** &nbsp;&nbsp; folks: **3,490**  &nbsp;&nbsp; `1,209 stars this week`
