...
1. [ascoders / weekly](https://github.com/ascoders/weekly)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,031** &nbsp;&nbsp; folks: **1,379**  &nbsp;&nbsp; `226 stars today`
...
1. [981011512 / --](https://github.com/981011512/--)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,203** &nbsp;&nbsp; folks: **419**  &nbsp;&nbsp; `157 stars today`
...
1. [gh0stkey / Binary-Learning](https://github.com/gh0stkey/Binary-Learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **208** &nbsp;&nbsp; folks: **22**  &nbsp;&nbsp; `55 stars today`
...
1. [godotengine / godot](https://github.com/godotengine/godot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **38,208** &nbsp;&nbsp; folks: **7,113**  &nbsp;&nbsp; `41 stars today`

1. [reactchartjs / react-chartjs-2](https://github.com/reactchartjs/react-chartjs-2)
    - React wrapper for Chart.js
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,866** &nbsp;&nbsp; folks: **698**  &nbsp;&nbsp; `10 stars today`
...
1. [dogecoin / dogecoin](https://github.com/dogecoin/dogecoin)
    - very currency
    - language: **C++** &nbsp;&nbsp; stars: **6,852** &nbsp;&nbsp; folks: **1,393**  &nbsp;&nbsp; `1,569 stars this week`

1. [Chia-Network / chia-blockchain](https://github.com/Chia-Network/chia-blockchain)
    - Chia blockchain python implementation (full node, farmer, harvester, timelord, and wallet)
    - language: **Python** &nbsp;&nbsp; stars: **4,389** &nbsp;&nbsp; folks: **433**  &nbsp;&nbsp; `2,423 stars this week`
...
1. [calendso / calendso](https://github.com/calendso/calendso)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,140** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `2,003 stars this week`
...
1. [wbkd / react-flow](https://github.com/wbkd/react-flow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,139** &nbsp;&nbsp; folks: **239**  &nbsp;&nbsp; `2,018 stars this week`
...
1. [elixir-nx / livebook](https://github.com/elixir-nx/livebook)
    ...
    - language: **Elixir** &nbsp;&nbsp; stars: **1,275** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `436 stars this week`
...
1. [chefyuan / algorithm-base](https://github.com/chefyuan/algorithm-base)
    - 专门为刚开始刷题的同学准备的算法基地，没有最细只有更细，立志用动画将晦涩难懂的算法说的通俗易懂！
    - language: **Java** &nbsp;&nbsp; stars: **3,846** &nbsp;&nbsp; folks: **559**  &nbsp;&nbsp; `1,392 stars this week`

1. [safemoonprotocol / Safemoon.sol](https://github.com/safemoonprotocol/Safemoon.sol)
    - safemoon contract
    - language: **Solidity** &nbsp;&nbsp; stars: **288** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `165 stars this week`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **165,104** &nbsp;&nbsp; folks: **45,645**  &nbsp;&nbsp; `2,366 stars this week`
...
1. [netdata / netdata](https://github.com/netdata/netdata)
    - Real-time performance monitoring, done right! https://www.netdata.cloud
    - language: **C** &nbsp;&nbsp; stars: **53,106** &nbsp;&nbsp; folks: **4,803**  &nbsp;&nbsp; `867 stars this week`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,690** &nbsp;&nbsp; folks: **7,954**  &nbsp;&nbsp; `1,724 stars this week`
...
1. [CSSEGISandData / COVID-19](https://github.com/CSSEGISandData/COVID-19)
    ...
    - language: **无** &nbsp;&nbsp; stars: **26,326** &nbsp;&nbsp; folks: **16,835**  &nbsp;&nbsp; `240 stars this week`
...
1. [storj / storj](https://github.com/storj/storj)
    - Ongoing Storj v3 development. Decentralized cloud object storage that is affordable, easy to use, private, and secure.
    - language: **Go** &nbsp;&nbsp; stars: **1,711** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `335 stars this week`
...
1. [coil-kt / coil](https://github.com/coil-kt/coil)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **6,120** &nbsp;&nbsp; folks: **341**  &nbsp;&nbsp; `116 stars this week`
...
1. [Ryujinx / Ryujinx](https://github.com/Ryujinx/Ryujinx)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,543** &nbsp;&nbsp; folks: **1,005**  &nbsp;&nbsp; `2,808 stars this month`
...
1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,792** &nbsp;&nbsp; folks: **652**  &nbsp;&nbsp; `1,487 stars this month`

1. [30-seconds / 30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
    - Short JavaScript code snippets for all your development needs
    - language: **JavaScript** &nbsp;&nbsp; stars: **72,690** &nbsp;&nbsp; folks: **7,954**  &nbsp;&nbsp; `3,133 stars this month`
